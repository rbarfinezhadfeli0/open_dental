# File: ./www.opendental.com/manual232/patientnew.html
...
<img src="images/patientAddSearch.gif" width="271" height="54"/><p>On the Select Patient window, at a minimum, enter the last name of the new patient and check that a record doesn't already exist.</p>
<p>To add a single patient, click <b>Add Pt</b> to open the <a href="patientedit.html">Edit Patient Information</a> Window. To add multiple family members, click <b>Add Many</b>. See <a href="familyadd.html">Add Family</a>. </p>
...
<p>In the <a href="family.html">Family Module</a>, select an existing patient in the family. <br/><img src="images/patientAddFamily.gif" width="208" height="100" class="ImageInParagraph"/></p>
<p>In the Toolbar, click<b> Add</b>. Enter patient details on the Edit Patient Information window, then click OK to save.</p>

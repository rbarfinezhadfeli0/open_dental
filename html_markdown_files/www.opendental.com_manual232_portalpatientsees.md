# File: ./www.opendental.com/manual232/portalpatientsees.html
...
<li><b>Remember User Name</b>: Patient can opt to remember their user name for future login.</li>
<li><b>Sign In</b>: Click to enter Patient Portal.</li>
</ul>
<p>The patient may be prompted to verify their personal information, as required by certain payment processors.<br/><img src="images/patientPortalVerify.png" width="248" height="225" class="ImageInParagraph"/></p>
<h2>Navigating Patient Portal</h2>
<p>Patients can navigate Patient Portal by clicking the tabs at the top. Tabs can be included or omitted depending on the settings selected by the office. See <a href="portalsettings.html">Patient Portal Settings</a>.</p>
<img src="images/patientPortalMain.gif" width="915" height="113"/><p class="MarginBottomZero">Additional patient portal options include:  </p>
<ul class="MarginBottomGap">
...
<li><b>Manage Credit Cards</b>: Add or remove credit cards used in the portal.  <div class="Note">Note:  Patients whose office utilizes PayConnect as their payment processor will be unable to add credit cards though the Manage Credit Cards window. Credit cards must be added during a transaction instead. </div>
</li>
</ul>
</li>
...
<p>The balance is reflective of the last generated statement, not the current balance of the account. If a patient does not have a statement on their account, this area will be blank.</p>
<h2>Plan</h2>
...
<h2>Summary</h2>
<p>In the Summary tab, patients can view, download, or transmit <a href="ehrccd.html">EHR Continuity of Care Document ( CCD )</a>.</p>

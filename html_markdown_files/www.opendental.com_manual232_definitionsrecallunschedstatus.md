# File: ./www.opendental.com/manual232/definitionsrecallunschedstatus.html
...
<img src="images/definitionsRecalUnschedStatus.png" width="816" height="532"/><p>The Recall/Unsched Status definition determines the Set Status/Unscheduled Status options available in the <a href="recalllist.html">Recall</a> and <a href="unscheduled.html">Unscheduled Lists</a>.</p>
...
<img src="images/definitionEditRecallUnschStat.png" width="433" height="233"/><p class="MarginBottomZero"></p>
<ul class="MarginBottomGap">
<li><b>Name</b>: Enter the status.</li>
<li><b>Abbreviation</b>: Enter the status abbreviation. Must be 7 characters or less.</li>
</ul>
</div>
</div>
</body>

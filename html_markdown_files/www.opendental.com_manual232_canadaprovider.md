# File: ./www.opendental.com/manual232/canadaprovider.html
...
<img src="images/canadaProvider.gif" width="858" height="686"/><p>For a description of fields, see <a href="providerseditwindow.html">Provider</a>. Some fields are specific to Canada. They are described below.</p>
<p><b>CDA Number</b>: The nine digit provider identification number.</p>
<p><b>Office Number</b>: The four digit office identifier. May contain numbers and letters.</p>
<p><b>Is CDAnet Member</b>: Must be checked to send electronic claims.</p>
<div class="Note">Note: <li>Taxonomy Code is not sent on Canadian claims.</li>

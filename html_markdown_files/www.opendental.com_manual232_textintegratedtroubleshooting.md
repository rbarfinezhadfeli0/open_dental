# File: ./www.opendental.com/manual232/textintegratedtroubleshooting.html
...
<p><b>My texts are being marked as spam. How can I avoid this?</b></p>
<p class="MarginBottomZero">Text messages can be marked as spam and blocked by the carrier. There is no way for Open Dental to unblock them. Here are some tips that can help prevent text messages from being blocked as spam. </p>
<ol class="MarginBottomGap">
<li>Avoid including URLs in messages. For eConfirmations, use the [ConfirmCode] field instead of [ConfirmURL]. </li>
<li>If your blocked messages do not include URLs, try altering the phrasing of the message.</li>
<li>If the above continues to fail, contact Open Dental Support. We may have an alternative solution in extreme situations.</li>
</ol>
</div>
</div>
</body>

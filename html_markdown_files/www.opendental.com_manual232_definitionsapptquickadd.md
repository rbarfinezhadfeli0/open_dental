# File: ./www.opendental.com/manual232/definitionsapptquickadd.html
...
<img src="images/definitionsApptProcsQuickAdd.png" width="816" height="525"/><p>The Appt Proc Quick Add definition determines the list of procedures available in the Single click list of the Edit Appointment window.</p>
<p>Double-click an existing item or click <b>Add</b> to create a new item. The Edit Definition window will open.</p>
<img src="images/definitionEditApptQuickAdd.png" width="433" height="231"/><p class="MarginBottomZero"></p>
<ul class="MarginBottomGap">
<li><b>Name</b>: Enter the item name. This identifies the item in the quick add list.</li>
...
<li>To associate a tooth number with the procedure, place the tooth number at the end of the code (e.g., D0220#7). The procedure code must have the treatment area set to <i>Tooth</i>. To enter the same code on multiple teeth, enter the code multiple times for each tooth (e.g., D0220#7, D0220#8, etc.)</li>

# File: ./www.opendental.com/manual232/definitionspaymentplancategories.html
...
<img src="images/definitionspaymentplancats.png" width="816" height="527"/><p>The Payment Plan Categories determine the list of category options available in the <a href="paymentplanpatient.html">Payment Plan</a> window. This list is empty by default. Add new categories as needed. </p>
<p>Assign a category to a patient or an insurance Payment Plan to distinguish one plan from another in a family with multiple payment plans. If no category is created, all payment plans will default to None.</p>
<p>Double-click an existing item or click <b>Add</b> to create a new item. The Edit Definition window will open.</p>
<img src="images/definitionEditPaymentPlanCats.png" width="433" height="228"/><p> Enter the category <b>Name</b> and click OK to save.</p>
</div>
</div>
</body>
</html>```

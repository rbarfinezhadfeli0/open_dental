# File: ./www.opendental.com/site/replicationreinitialize.html
...
<body onload="BodyLoaded('replicationreinitialize','replication','advancedtopics','documentation')">
	<nav class="LeftTree">

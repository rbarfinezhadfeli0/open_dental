# File: ./www.opendental.com/site/encryptionmariadb.html
...
<body onload="BodyLoaded('encryptionmariadb','encryption','securitycomputers','computernetworksetup','documentation')">
	<nav class="LeftTree">

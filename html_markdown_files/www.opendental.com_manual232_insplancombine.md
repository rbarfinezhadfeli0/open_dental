# File: ./www.opendental.com/manual232/insplancombine.html
...
<li>Verify that employer, group #, group name, plan details, plan notes, and benefits (e.g., percenages, annual max, etc.) are all the same.</li>
...
<li>Verify which plan has the most recent and accurate information. When combining, only one insurnace plan's details are kept. Other benefits marked as a patient override are not be lost when combining plans.</li>
...
<li>A warning appears. Click <b>OK</b> to proceeed with combing the insurance plans. Click <b>Cancel</b> to stop the process. <br/><img src="images/insPlanCombineConfirm.png" width="410" height="159" class="ImageInParagraph"/></li>

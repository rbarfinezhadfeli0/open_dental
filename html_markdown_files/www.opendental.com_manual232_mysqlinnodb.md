# File: ./www.opendental.com/manual232/mysqlinnodb.html
...
<title>Open Dental Software - MySQL InnoDB</title>
...
<li>Go to Tools, Database Maintenance. Select the Tools tab and click InnoDB. <br/><img src="images/InnoDBdatabasetools.png" width="844" height="618" class="ImageInParagraph"/></li>
<li>Use the interface to convert all Open Dental tables from MyISAM to InnoDB. This process takes a long time since it is rewriting all of the database tables. Ensure that it ends successfully. <br/><img src="images/innoDBdatabaseconvert.png" width="709" height="526" class="ImageInParagraph"/></li>
</ol>

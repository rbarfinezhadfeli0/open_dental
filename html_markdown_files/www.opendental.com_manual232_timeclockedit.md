# File: ./www.opendental.com/manual232/timeclockedit.html
...
<img src="images/timeCard.png" width="915" height="481"/><p>Alternatively, in <a href="timecardmanage.html">Time Card Management</a>, double-click an employee.</p>
...
<li><b>OT</b>: Hours entered for a time card adjusmtent with <i>Overtime Adjustment</i> checked.  <ul>
...
<ol>
<li>Double-click a row in the <b>Time Card</b> grid. <br/><img src="images/clockEvent.png" width="679" height="516" class="ImageInParagraph"/></li>
...
<li><b>Overtime</b>: If there is an overtime rule for daily hours (e.g. overtime after 8 hours), and an employee meets the criteria, a value is entered. Hours will then be transferred from regular time to overtime in calculation totals. An override can be manually entered.</li>
...
<li><b>Rate 2 Time</b>: How many of the total hours are Rate 2 hours (differential hours). Can be overidden manually.</li>
<li><b>Rate 3 Time</b>: How many of the total hours are Rate 3 (weekend hours). Can be overidden manually.</li>
...
<p>A user with the <i>Edit All Time Cards</i> permission, who is not the same person as the employee whose Time Card needs to be edited, will need to edit the clock event. </p>

# File: ./www.opendental.com/manual243/email.html
...
<li>This method does not violate <a href="../site/hipaa.html">HIPAA</a> as long as protected health information (PHI) is not sent. </li>
</ul>
<h2>Secure Email</h2>
...
<p><b>Reminder</b>: If using an email client (such as Microsoft Outlook) to email multiple patients (e.g., mass email), be sure to use a <i>Bcc</i> field rather than <i>To</i> or <i>Cc</i> to avoid exposing patient email addresses to other patients.</p>
</div>
</div>
</body>
</html>```

# File: ./www.opendental.com/manual232/reportdailypayments.html
...
<img src="images/reportDailyPayments.png" width="854" height="526"/><p>The Daily Payments report is a list of all <a href="payment.html">Patient Payments</a> and <a href="claimpayfinalize.html">Claim Payments</a>.</p>
...
<img src="images/reportDailyPaymentsPaper.png" width="841" height="643"/><p class="MarginBottomZero">The Daily Payments report groups insurance payments and patient payments separately. Within those groups, payments are further grouped by Payment Type (e.g., check, credit card, etc).  </p>
<ul class="MarginBottomGap">

# File: ./www.opendental.com/manual232/alerts.html
...
<img src="images/alertsExample.png" width="903" height="387"/><p>Only alerts the user is subscribed to are shown. When using Clinics, only alerts for the currently selected clinic show, and only when the logged on user is subscribed to the alert category.</p>
<p><img src="images/alertShow.png" width="70" height="26" style="margin-bottom: 0px"/> When there are new, unread alerts, the Alert menu item appears red and indicates the number of active alerts. </p>
<p class="MarginBottomZero">Also See: </p>
<ul class="MarginBottomGap">
<li><a href="alertsubscribe.html">Alert Subscription</a></li>
<li><a href="alertcategories.html">Alert Categories</a></li>
</ul>
<p class="MarginBottomZero">Select an alert to take action, or select multiple alerts to quickly acknowledge them. The options vary depending on the alert. </p>
<ul class="MarginBottomGap">
...
<td>Alert will display when CareCredit users get an error when running batch quickscreens.</td>

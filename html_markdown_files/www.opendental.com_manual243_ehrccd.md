# File: ./www.opendental.com/manual243/ehrccd.html
...
<title>Open Dental Software - Continuity of Care Document (CCD)</title>
...
<body onload="BodyLoaded('ehrccd','+chartToolbar','chart','modules','manual')">
<nav class="LeftTree">
...
<ul class="MarginBottomGap">
<li>If the Proc Code is a CDT code, the CDT code and description show. These cannot be edited.</li>

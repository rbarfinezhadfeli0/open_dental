# File: ./www.opendental.com/manual243/securityusergroups.html
...
<img src="images/securityUserGroups.png" width="915" height="497"/><p class="MarginBottomZero">Also see:  </p>
...
<p>If a box is checked for a permission with a <a href="securitylockdates.html">User Group Lock Date</a>, the following window appears. This allows users to prevent alteration of historical data. To set a date limitation, enter a value in the Date or Days field, then click <b>Save</b> to keep changes. If left blank, there is no lock date.</p>
<img src="images/securityDateLimits.png" width="485" height="243"/><p class="MarginBottomZero"></p>
<ul class="MarginBottomGap">

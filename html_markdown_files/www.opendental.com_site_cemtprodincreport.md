# File: ./www.opendental.com/site/cemtprodincreport.html
...
<body onload="BodyLoaded('cemtprodincreport','central','advancedtopics','documentation')">
	<nav class="LeftTree">
...
<img src="images/centralPandIreport.png" width="483" height="373"/><p>Select the report criteria. See <a href="../autoLogin.aspx%EF%B9%96ReturnUrl=%EA%A4%B7help253%EA%A4%B7reportprodinc.html">Production and Income Reports</a> for a description of each field.</p>
...
<p class="MarginBottomZero"><b>Show Insurance Write-offs:</b> Select when to apply insurance write-offs to production amounts. See <a href="../autoLogin.aspx%EF%B9%96ReturnUrl=%EA%A4%B7help253%EA%A4%B7writeoffstoproduction.html">Show Insurance Write-offs</a> for more details. Set the default in Report Setup - Misc Settings.  </p>
<ul class="MarginBottomGap">

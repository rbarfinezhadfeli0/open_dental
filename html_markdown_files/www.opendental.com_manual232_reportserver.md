# File: ./www.opendental.com/manual232/reportserver.html
...
<img src="images/reportServer.png" width="566" height="712"/><p>Alternatively, in the <a href="reportsstandard.html">Standard Reports</a> window, click <a href="reportssetup.html">Setup</a>. Select the <b>Report Server</b> tab.</p>
...
<p>Currently the report server can run the following:</p>
...
<p class="MarginBottomZero"><b>Direct Connection</b>: Select to connect via a direct connection.  </p>
<ul class="MarginBottomGap">
...
<li><b>MySQL Password</b>: The user password (if you have set up MySQL users and password).</li>
</ul>
<p class="MarginBottomZero"><b>Middle Tier, URI</b>: Select to connect via <a href="middletier.html">Middle Tier</a>.  </p>
<ul class="MarginBottomGap">

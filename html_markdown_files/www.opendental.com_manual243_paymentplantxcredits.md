# File: ./www.opendental.com/manual243/paymentplantxcredits.html
...
<img src="images/payplanProceduresCredits.png" width="915" height="391"/><p>The total amount of credits attached determines the amount subtracted from the patient balance (PayPln: Credit). See Attaching Payment Plan Credits section for instructions on attaching Pay Plan Credits.</p>
...
<p><b>Available Procedures</b>: Procedures with a <i>Rem Before</i> amount other than $0 are listed in yellow. Any treatment credits attached to other Old Payment Plans are considered in the <i>Rem Before</i> amount. </p>
<p class="MarginBottomZero"><img src="images/payPlanCreditAvailProcs.png" width="369" height="97"/></p>
...
<li>For treatment planned procedures, Rem Before includes <a href="discountplan.html">Discount Plan Subscriber Edit</a> adjustments but not <a href="treatmentplandiscounts.html">TP Procedure Discounts</a>. Manually enter the correct amount after TP procedure discounts when adding Tx Credits for these procedures.</li>
...
<p class="MarginBottomZero"><img src="images/payPlanCreditAttached.png" width="379" height="98"/></p>
<ul class="MarginBottomGap">
<li>Credit Date: The date the credit appears on the account.</li>
...
<br/><p>To add a credit for a procedure, highlight the procedure first. The credit fields populate with the procedure information. Modify if needed, then click <b>Add</b>. A procedure can only be attached to one Payment Plan. It cannot be attached to both an Old Payment Plan and Payment Plan.</p>
...
<li>From the <a href="paymentplanpatient.html">Old Payment Plan</a> window, click <b>View Tx Credits</b>.</li>
...
<ol class="MarginBottomGap">
<li>From the Old Payment Plan window, click <b>View Tx Credits</b>.</li>
...
<p>Reversals can be made manually by detaching treatment credits.</p>

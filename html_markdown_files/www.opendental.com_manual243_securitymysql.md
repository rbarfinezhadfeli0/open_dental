# File: ./www.opendental.com/manual243/securitymysql.html
...
<p>When users connect from the client computers, they never see or have access to the users that are set up in this file. They connect using an Open Dental username and password. See <a href="choosedatabase.html">Choose Database</a> for an example.</p>

# File: ./www.opendental.com/manual243/orthodontic.html
...
<h2>General Setup</h2>
<p><a href="preferences.html">Preferences</a>: For Orthodontic-only practices, set the tooth nomenclature to <i>Palmer</i>. Set default Ortho preferences for display options, claims, Ortho Chart, etc.</p>
...
<p class="MarginBottomZero"><a href="procedurecodes.html">Procedure Codes</a>: Add and edit procedure codes and set default procedure fees and time patterns. Offices generally have two types of procedure codes. </p>
...
<li><a href="ortho.html">Ortho Tab</a>: Utilize the Ortho Tab to chart <a href="orthohardwaresetup.html">Hardware</a> and <a href="orthoprescriptionssetup.html">Prescriptions</a>, view the Ortho Chart, see patient progress, and see a visual of ortho hardware. This is helpful for offices who may be practicing multiple specialites. <ul>
<li>The Ortho Tab always shows teeth with Palmer tooth nomenclature, regardless of the <i>Tooth Nomenclature</i>preference. </li>
<li>Enable the preference, <i>Show Ortho button and tab in Chart module</i>, to use the Ortho Tab.</li>
</ul>
</li>
</ul>
...
<li><a href="paymentplandynamic.html">Payment Plan</a>: Set up an unlimited amount of Payment Plans per patient. The guarantor does not have to be in the same family as the patient. If using the Ortho Case feature, set up a Payment Plan directly from the Ortho Case, attached to the ortho treatment.</li>
<li><a href="paymentplanins.html">Insurance Payment Plans</a>: Create to track insurance's expected ortho payments. The total expected insurance payment is removed from the patient's overall balance. </li>

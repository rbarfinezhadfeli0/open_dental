# File: ./www.opendental.com/manual243/procedurelocking.html
...
<img src="images/procLockAppend.png" width="618" height="514"/><p>Enter the new note in the <b>Appended Note</b> text area, or add an <a href="autonotes.html">Auto Note</a>. Appended notes are dated, and appear in the Progress Notes below the procedure. Appended notes can be signed electronically, see <a href="electronicsignatures.html">Electronic Signatures</a>. The user and signed status shown in progress notes is the user to last append the procedure. An <a href="alerts.html">Alert</a> is generated when a note is appended by another user.</p>
<h2>Invalidating</h2>

# File: ./www.opendental.com/manual232/dosespotsetup.html
...
<li>Select DoseSpot as the eRx Solution. If the practice is in the process of switching to DoseSpot from NewCrop eRX, select DoseSpot with NewCrop eRX.<br/><div class="Note">Note: To continue the use of NewCrop eRX, check <i>Allow NewCrop eRX in the <a href="providerseditwindow.html">Provider Edit Window</a> for each needed provider until DoseSpot identity proofing is complete.</i></div>
</li>
...
<li>After submitting the form, an email is sent to Practice Administrator's email address with instructions on the next step.</li>
...
<li>Enter mobile phone number and click <i>Send Me DUO Activation Texts</i> to receive two text messages: one text to download the DUO Mobile app and another to sync the app to the Admin Console login.<br/><div class="Note">Note: DUO only supports Andriod 10+ and iOS 14+.</div>
</li>
...
<p><div class="Note">Note: EHR Incentive Program: e-Prescribing for the EHR Incentive Program is only possible with NewCrop eRx - Comprehensive.</div>
</p>
<h2>New Phone </h2>

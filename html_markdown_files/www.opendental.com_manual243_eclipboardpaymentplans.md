# File: ./www.opendental.com/manual243/eclipboardpaymentplans.html
...
<body onload="BodyLoaded('eclipboardpaymentplans','paymentplandynamic','account','modules','manual')">
<nav class="LeftTree">
...
<p>In a <a href="paymentplandynamic.html">Payment Plan</a>, click <b>eClipboard</b>.</p>
<img src="images/eClipboardPaymentPlan.png" width="681" height="59"/><p>To save signed Payment Plans to the Imaging Module, enable <i>In eClipboard, save signed Payment Plans as PDF</i> in <a href="preferences.html">Preferences</a>.</p>

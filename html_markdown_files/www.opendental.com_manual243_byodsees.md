# File: ./www.opendental.com/manual243/byodsees.html
...
<p>
<div class="Note">Note: The BYOD feature will be removed from Open Dental starting with Version 25.1. Open Dental is currently working on a replacement for BYOD. In the interim, offices can use the <a href="https://www.opendental.com/manual243/webforms.xml">Web Forms</a> feature to allow patients to fill out forms prior to their appointment.</div></p>
...
<li>If <i>Allow payment when patient is checking in </i> is enabled in eClipboard Setup, the <a href="eclipboardpayment.html">eClipboard: Payment</a> feature can be utilized using BYOD.</li>
</ul>
<h2>App Flow</h2>

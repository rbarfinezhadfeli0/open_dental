# File: ./www.opendental.com/manual243/bridgeaudaxceph.html
...
<img src="images/bridgeAudaxCeph.png" width="770" height="594"/><p>AudaxCeph is an x-ray analysis software. Website: <a href="http://www.audaxceph.com/" target="_blank">http://www.audaxceph.com/</a>.</p>
...
<p>The AudaxCeph bridge must be open to use the bridge button in Open Dental. If a patient is selected in Open Dental, but AudaxCeph is already open with a different patient selected, clicking the bridge button does not change the patient.</p>
<h2>Technical Details</h2>
<p>Because of the AudaxCeph bridge, the following occurs:</p>
<p>Patient Status: Every patient opened in AudaxCeph has a patient status of active, even if a different patient status (e.g., deceased, inactive) has been selected on the Edit Patient Information window in Open Dental.</p>
...
<p>When the bridge is enabled, Open Dental creates an update.xml file in the installation folder which AudaxCeph reads from.</p>
</div>
</div>
</body>
</html>```

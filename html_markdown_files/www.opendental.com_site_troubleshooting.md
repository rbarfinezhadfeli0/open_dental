# File: ./www.opendental.com/site/troubleshooting.html
...
<body onload="BodyLoaded('troubleshooting','installation','documentation')">
	<nav class="LeftTree">
...
<li>Visit <a href="computerrequirements.html">Computer Requirements</a> for a full list of supported operating systems.</li>
</ul>
...
<p class="MarginBottomZero">Read Only Database: Are your database files set to read only? The Choose Database window may tell you, <i>Database is present but not accepting commands</i> instead of <i>database not present</i>.  </p>
<ul class="MarginBottomGap">
...
<p>See <a href="screensize.html">Screen Size</a> for additional information on screen scaling, resolution and display size.</p>
...
<ol>
<li>Run Database Maintenance.</li>
<li>Make sure you are using the most current version. In the Main Menu, click Help, Update. Check for Updates to check. If a new build is available for your version, update.</li>

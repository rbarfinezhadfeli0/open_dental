# File: ./www.opendental.com/manual232/econfirmationexclusiondays.html
...
<title>Open Dental Software - eConfirmation Exclusion Days</title>
...
<p class="MarginBottomZero"><b>Exclusion Dates</b>: Add specific dates to exclude when sending eConfirmations (e.g., holidays). </p>
...
<p><div class="Note">Note: Settings only affect future dates. Setting an exclusion date for today does not stop eConfirmations from sending.</div>
</p>
</div>
</div>
</body>

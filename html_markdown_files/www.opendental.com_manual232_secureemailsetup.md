# File: ./www.opendental.com/manual232/secureemailsetup.html
...
<img src="images/secureEmailSetup.png" width="910" height="429"/><p>Use this window to enable and setup the Secure Email feature.</p>
...
<p>Enable Secure Email for each clinic you want to send emails through.</p>
<p>An <i>X</i> indicates the clinic is already signed up for Secure Email. Click <b>Sign Up</b> to enable a new clinic. The <a href="eservicessignup.html">eServices Signup</a> window will open.</p>
</div>
</div>
</body>
</html>```

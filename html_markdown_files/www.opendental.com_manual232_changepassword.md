# File: ./www.opendental.com/manual232/changepassword.html
...
<p>In the <a href="mainmenu.html">Main Menu</a>, click File, <b>User Password</b>.</p>
<img src="images/changepassword.png" width="494" height="240"/><p> The logged-on user can change their password at any time.</p>
...
<p>To create an initial temporary password, go to <a href="securityusers.html">User Edit</a> for the new user, then click Create Password. To require a password reset when the user first logs on, check <i>Require Password Reset</i> in the user settings.</p>
</div>
</div>
</body>
</html>```

# File: ./www.opendental.com/manual232/accounting.html
...
<img src="images/accounting.png" width="494" height="484"/><p>The Chart of Accounts is a list of the accounts used to organize finances and divide expenses, revenue, assets, liabilities, and equity. When set up correctly, certain transactions in Open Dental automatically create accounting transactions in the Chart of Accounts. </p>
<h2>Menu Items</h2>
...
<p><b>Edit</b>: Select an account, then click to make edits to the name, type, inactive status, and color. See Edit Account below.</p>
<p><b>Export</b>: Save the Chart of Accounts grid as a text or Excel file. Change the <i>As of Date</i> to export the Balance totals for the date entered.</p>
...
<h2>Edit Account</h2>
<p>To add a new account, click <b>Add</b>. To edit an existing account, select the account and click <b>Edit</b>.</p>
<img src="images/accountEdit.png" width="586" height="302"/><p><b>Description</b>: Enter the account name.</p>
...
<li>Click <b>OK </b>to save the change and close the window.</li>
</ol>
</li>
</ol>
</div>

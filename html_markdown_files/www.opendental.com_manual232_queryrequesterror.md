# File: ./www.opendental.com/manual232/queryrequesterror.html
...
<title>Open Dental Software Manual - Query Request Error</title>
<!-- InstanceEndEditable -->
    		...
    		<td width="100%" align="left">
      			...
      			<tr>
        			<td height="25" align="right" valign="middle" style="padding-right:10px;">
								...
								<a href="manual.html" class="TopLink"><img src="../open-dental/UserManual.gif" width="27" height="15" border="0">User Manual</a>
								...
								<a href="search.html" class="TopLink"><img src="../open-dental/SearchIcon.gif" width="27" height="15" border="0">Search</a>
							</td>
						</tr>
						<tr>
  ...
  <tr>
    <td bgcolor="#FFFFFF" style="padding-left:15px; padding-top:20px; padding-right:15px; background-image: url(../open-dental/Back.jpg); background-repeat: repeat-x;">
			<p style="margin-top: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 20px; font-weight: bolder; color: #FFFFFF;">
				<!-- InstanceBeginEditable name="title" -->Query Request Error <!-- InstanceEndEditable -->
			</p>
			<!-- InstanceBeginEditable name="body" -->
      	<h4><strong>Error processing query request</strong></h4>
      	<p>There was an error when trying to complete your query request. This could happen because the browser is trying to defend against scripting attacks. Sometimes less than signs ('&lt;') within queries can trigger this, for example ProcDate&lt;DATE(AptDateTime). Adding a space after the less than sign will solve this: ProcDate &lt; DATE(AptDateTime).</p>
      	<p>Alternatively, you can email the query to <SCRIPT TYPE="text/javascript"><!-- 
				emailE='opendental.com'
				emailE=('service' + '@' + emailE)
				document.write('<A href="mailto:' + emailE + '">' + emailE + '</a>')//-->
				</script>
              	<NOSCRIPT>
              Email address protected by JavaScript.  Please enable JavaScript to view it.
              	</NOSCRIPT> 
      <!-- InstanceEndEditable -->
			<p>&nbsp;</p>
		</td>

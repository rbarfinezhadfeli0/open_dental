# File: ./www.opendental.com/manual232/reportpresentedtp.html
...
<img src="images/reportPresentedTP.png" width="500" height="493"/><p> To control user access to this report, see <a href="reportsecurity.html">Report Setup: Security Permissions</a>.</p>
<h2>Filters and Report Options</h2>
<p>Set criteria before generating the report</p>
<p><b>Calendars:</b> Select the date range for the report. Set the start date in the left calendar and the end date in the right calendar. Only production for procedures set complete within the date range will be included. The default is the last calendar month. </p>
<p class="MarginBottomZero">Report Type: Select an option to change the generated report data.  </p>
<ul class="MarginBottomGap">
<li><b>Detailed</b>: Select to show production by individual procedure.</li>
<li><b>Total</b>: Select to how total production for each user or presenter.</li>
</ul>
<p class="MarginBottomZero">Order Presented: Production for procedures on multiple treatment plans will only be counted once. Select to whom production for these procedures should be attributed.  </p>
<ul class="MarginBottomGap">
...
<p class="MarginBottomZero">User Displayed: Select how the presenter will be determined.  </p>
<ul class="MarginBottomGap">
<li><b>Presenter</b>: The <i>presenter</i> associated with the treatment plan.</li>
<li><b>Entry User</b>: The <i>user entry</i> associated with the treatment plan.</li>
</ul>
<p class="MarginBottomZero"><b>Users</b>: Select the users include. Ctrl + click to select multiple users or check <b>All</b> to include all listed users. </p>
<ul class="MarginBottomGap">
...
<p><b>Clinics:</b> Select the clinics to include. Ctrl + click to select multiple clinics or check <b>All (Includes hidden)</b> to include all clinics, including those marked hidden. Filters by clinics assigned to completed procedure.</p>
<h2>Report Preview</h2>
<p>After setting the report criteria, click <b>OK</b> to generate a print preview of the report. The layout of the resulting report will depending on the selected <i>Report Type</i>. Below are examples of the resulting report descriptions of the report columns.</p>
<p>For a description of toolbar buttons, see <a href="reportcomplex.html">Complex Report System</a>.</p>
<br/><p><b>Report Type: Detailed Report</b></p>
<img src="images/reportPresentedTPPrinted.png" width="841" height="420"/><p><b>Report Type: Totals Report</b></p>
<img src="images/reportPresentedTPPrintedTotal.png" width="841" height="348"/><p class="MarginBottomZero">Some columns may change depending on the selected <i>Report Type</i>. </p>
<ul>
...
<li>The following fields Only appears when Report Type of <i>Detailed Report</i> is selected:  <ul>
...
<li><b>NetProduction</b>: Net production = GrossProd - Write-offs - Adjustments.</li>
</ul>

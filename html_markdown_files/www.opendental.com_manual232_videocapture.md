# File: ./www.opendental.com/manual232/videocapture.html
...
<img src="images/imagingVideo.png" width="429" height="340"/><p>Any webcam or intraoral camera should be compatible with Open Dental. For additional details, see <a href="imagingcameracompatibility.html">Imaging Camera Compatibility</a></p>
...
<li>If no <i>Default Image Category for video capture</i> is set, the image is saved to the currently selected image category.</li>
<li>If no image category is currently selected, the image is saved to <i>Default Image Category</i> in Preferences.</li>
<li>If no <i>Default Image Category</i> is set, the image is saved to the top-most image category. </li>
</ul>
</div>
</div>
</body>

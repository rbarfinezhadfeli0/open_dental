# File: ./www.opendental.com/manual243/emailtemplates.html
...
<p>Click <b>Add</b> to create a new template or highlight an existing template and click <b>Edit</b> to make changes. <br/><img src="images/emailTemplateEdit.png" width="770" height="477" class="ImageInParagraph"/></p>
...
<li><b>Body</b>: Enter the body message. <a href="rightclicktextboxes.html">Right-Click</a> the text box for additional options.</li>
...
<li><b>Subject Fields / Body Fields</b>: Insert replacement fields into the Subject or Body. Message replacement fields pull information from the database to insert into the message (e.g., insert <span class="codeblock">[ApptDate]</span> to automatically insert appointment date). <ul>
<li>Replacement fields can be manually entered (e.g., [LName]), but must match the field name exactly. They are case-sensitive. </li>
<li>Position the cursor to where the field should be entered, then double-click an item from the list. Fields in red text cannot be inserted.</li>
</ul>
<img src="images/emailMessageReplace.png" width="676" height="367"/></li>
</ul>
</div>
</div>
</body>

# File: ./www.opendental.com/site/canadaprovider.html
...
<body onload="BodyLoaded('canadaprovider','canada','countries','documentation')">
	<nav class="LeftTree">
...
<p>For <a href="canada.html">Canada</a> users, in <a href="../autoLogin.aspx%EF%B9%96ReturnUrl=%EA%A4%B7help253%EA%A4%B7providers.html">Providers</a> List, click <b>Add</b>, or double-click an existing provider to edit.</p>
<img src="images/canadaProvider.png" width="897" height="692"/><p>For a description of fields, see <a href="../autoLogin.aspx%EF%B9%96ReturnUrl=%EA%A4%B7help253%EA%A4%B7providerseditwindow.html">Provider</a>. Some fields are specific to Canada. They are described below.</p>

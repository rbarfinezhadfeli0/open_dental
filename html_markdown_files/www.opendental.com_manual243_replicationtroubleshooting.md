# File: ./www.opendental.com/manual243/replicationtroubleshooting.html
...
<li>Run <span class="codeblock">SHOW SLAVE STATUS\G</span> in the mysql command interface. <br/><img src="images/Replication_errorlog.gif" width="641" height="548" class="ImageInParagraph"/></li>
<li>Look through the error log for details about what caused replication to fail.</li>
<li>Refer to the problems and possible solutions below, or contact support for assistance. If support becomes involved they will need access to a copy of the database and all log files.</li>
</ol>
<h2>Errors/Issues</h2>
...
<p>Contact support and provide access to a copy of the database and all log files.</p>

# File: ./www.opendental.com/manual232/tsisetup.html
...
<img src="images/bridgeTransworld.png" width="436" height="571"/><p class="MarginBottomZero">To begin using the <a href="tsicollections.html">TSI Collections</a> Interface, there are three basic steps: </p>
...
<li>Do not manually change a patient's billing type from the TSI <i>C</i> billing type to another. Manual changes will not stop TSI account management, however will stop account syncing that could result in double, yet different statements.</li>
</ul>

# File: ./www.opendental.com/manual232/messagingbuttons.html
...
<img src="images/messagingButtonSetup.gif" width="664" height="414"/><p>All computers in the office list on the left. The computer that you are currently on is indicated by (this computer).</p>
...
<li>Select All if the button will be the same for all computers (e.g., Op 1, Op 2, Op 3, Pt Ready, Ph Asst).</li>
<li>Select one or multiple computers if the button is only relevant to certain computers (e.g., Hygiene ops only, Op 1 only, etc.).</li>
</ul>
</li>
<li>Double-click a button in the Buttons area.</li>
<li>Enter button criteria, then click OK.<br/><img src="images/messagingButtonDrOp1.gif" width="681" height="374" class="ImageInParagraph"/><ul>

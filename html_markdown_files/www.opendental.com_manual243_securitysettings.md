# File: ./www.opendental.com/manual243/securitysettings.html
...
<img src="images/securityGlobalSecuritySettings.png" width="372" height="582"/><p class="MarginBottomZero"><b>Time Card Security Enabled:</b></p>
<ul class="MarginBottomGap">
<li>Checked: Enables the <i>Users cannot edit their own time card</i> and <i>Users cannot edit their own time card except current pay period</i> boxes (see below). Limits users without the <i>Edit All Time Cards</i> permission from viewing other employee timecards or creating clock events for other employees.</li>
<li>Unchecked: Disables the <i>Users cannot edit their own time card</i> and <i>Users cannot edit their own time card except current pay period</i> boxes. Allows users to create clock events (e.g., Clock In) for any employee. Allows all users to view any employee Time Card. </li>
</ul>
<p class="MarginBottomZero"><b>Users cannot edit their own time card:</b> Can only be changed if the Time Card Security Enabled box is also checked. The setting of this box overrides the <i>Edit All Time Cards</i> security permission.  </p>
<ul class="MarginBottomGap">
...
<p class="MarginBottomZero"><b>Users cannot edit their own time card except current pay period</b>: Can only be changed if the <i>Time Card Security Enabled</i> box is also checked.  </p>
<ul class="MarginBottomGap">
...
<ul class="MarginBottomGap">
<li>Checked: When passwords must be strong is enabled, users who do not have a strong password are required to change their password the next time they log on so it meets criteria.</li>
<li>Unchecked: Users are not required or prompted to change to a strong password.</li>
</ul>
...
<li>Unchecked: Users select their user name from a list.</li>
</ul>
<p class="MarginBottomZero"><b>When logging in with a badge, require a password</b>:  </p>
<ul class="MarginBottomGap">
<li>Checked: If using <a href="securitybadges.html">Badges</a> to <a href="securitylogin.html">Log On</a> to Open Dental, a user is selected when scanning a badge. Users must type their password.</li>
<li>Unchecked: If using badges to log on, the user is immediately logged on to Open Dental when scanning a badge. </li>
</ul>
...
<ul class="MarginBottomGap">
<li>Checked: When a user <a href="securitylogin.html">Logs Off</a>, the previously selected patient, as well as the 5 previous patients in the dropdown menu, remain selected for the next user who logs on.  <ul>
<li>If the previously selected patient is not assigned to a clinic, the patient is not maintained.</li>
<li>If the next user to log on does not have access to the clinics associated with the previously selected patients, those patients do not show in the list.</li>
</ul>
</li>
...
<p><b>Automatic logoff time in minutes (0 to disable):</b> Set a time when, after a period of inactivity, Open Dental automatically logs off the current user. Enter 0 to prevent automatic log off. If automatic log off is turned on, and a user manually clicks Log Off, any unsaved changes are lost, and no warning message shows.</p>

# File: ./www.opendental.com/manual232/closeoutmonth.html
...
<b>Run Reports</b><p class="MarginBottomZero">The following reports can be run anytime, but should be run at least once a month: </p>

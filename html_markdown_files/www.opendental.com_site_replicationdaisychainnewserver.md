# File: ./www.opendental.com/site/replicationdaisychainnewserver.html
...
<body onload="BodyLoaded('replicationdaisychainnewserver','replication','advancedtopics','documentation')">
	<nav class="LeftTree">
...
<li>Add the new server to <a href="../autoLogin.aspx%EF%B9%96ReturnUrl=%EA%A4%B7help253%EA%A4%B7replicationservers.html">Replication Setup</a>. This step can alternatively be completed at the end of setup.</li>
<li>Shutdown all workstations. <a href="../autoLogin.aspx%EF%B9%96ReturnUrl=%EA%A4%B7help253%EA%A4%B7shutdown.html">Shutdown Workstations</a></li>

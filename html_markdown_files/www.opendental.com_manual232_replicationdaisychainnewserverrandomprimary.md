# File: ./www.opendental.com/manual232/replicationdaisychainnewserverrandomprimary.html
...
<li>On the Primary server where the database is located, log in to Open Dental. In the main menu, click Setup, Advanced Setup, Replication. Click Add to add a server. When complete, this database is ready to be replicated to others servers. <ul>

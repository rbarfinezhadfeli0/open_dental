# File: ./www.opendental.com/manual232/newcropmedications.html
...
<p>The medication will be added to the Current Medications list with a  <img src="images/newCropMedEntryIcon.png" width="17" height="20" style="margin-bottom: 0px"/> icon to indicate it was added via the Med Entry tab. The medication will also be added the patient's active medications in Open Dental.</p>
...
<li>Click <b>Discontinue</b>. </li>
 The medication will be moved to the <i>Discontinued Medications</i> list. The medication will also be marked discontinued in Open Dental when the Chart Module is refreshed (a <i>Stop Date</i> will be entered). To change a current medication, click <b>Edit</b>. </ol>
</div>
</div>
</body>
</html>```

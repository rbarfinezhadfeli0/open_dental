# File: ./www.opendental.com/manual232/claimsera835troubleshooting.html
...
<p><p><b>I have a duplicate ERA.</b></p>
</p>
...
<p>This means you are not signed up for the ERA download service with <a href="eclaimsclaimconnect.html">ClaimConnect</a>. Contact ClaimConnect to sign up.</p>
<p>ClaimConnect Note: Once ERAs are downloaded they are marked processed on the ClaimConnect website. To mark an ERA as unprocessed (e.g., if there is an error), do so on the ClaimConnect website.</p>

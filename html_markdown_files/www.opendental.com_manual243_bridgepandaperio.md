# File: ./www.opendental.com/manual243/bridgepandaperio.html
...
<img src="images/bridgePandaPerio.png" width="770" height="594"/><p><div class="Note">Note: In order to successfully bridge to PandaPerio, PandaLauncher is required.</div>
</p>
...
<p>This bridge passes the patient's Patient ID, First Name, Last Name, Birthdate, SSN, Home Phone Number, and Work Phone Number. If there is a referral attached and the referral is flagged as <i>Is Doctor</i>, then the Referring Provider's ReferralNum, First Name, Last Name, Address, and Phone Number are also passed over.</p>
<p>If the patient is a patient clone, the bridge transfers the non-clone patient information.</p>
<p>To write to an ini file instead, use the <a href="bridgepandaperioadvanced.html">PANDA Perio (advanced) Bridge </a>. </p>
</div>
</div>
</body>
</html>```

# File: ./www.opendental.com/manual243/definitionswebschedexistingpatappttypes.html
...
<p>Double-click an existing item to edit or click <b>Add</b> to create a new item. The following Edit Definition window will open.</p>
<img src="images/definitionEditWebSchedExistingApptType.png" width="481" height="198"/><p class="MarginBottomZero"></p>
<ul class="MarginBottomGap">
<li><b>Name</b>: Enter the appointment reason description. The reason text is also added to the <a href="aptedit.html">Appointment</a> note.</li>
<li><b>Appointment Type</b>: Click <b>[...]</b> to assign an Appointment Type. Each reason can be assigned to one Appointment Type.</li>
<li><b>Restrict to Specific Blockouts</b>: Click <b>[...]</b> to restrict this Appointment Type to only be scheduled on a specific <a href="definitionsblockouts.html">Blockout</a>. Multiple appointment types can be restricted to the same blockout.</li>
</ul>
<p><b>Delete</b>: Click to remove a reason not in use.</p>
<p>Click <b>Save</b> to keep changes to save.</p>

# File: ./www.opendental.com/manual243/mainmenu.html
...
<img src="images/mainmenuHelp.png"/>
<p>
<ul>
	<li>Online Support: Open the Contact page for Support hours and contact information. </li>
	<li>Online Help - Documentation: Open the Open Dental online documentation. </li>
	<li>Online Help - Search: Open the Open Dental online documentation Search page. </li>
	<li>Training Videos: Open the Webinars webpage to quickly find webinar playlists by topic.</li>
	<li>Query Monitor: Opens the <xref href="querymonitor.xml"/> window to allow real-time monitoring of queries to the MySQL database.</li>
	<li>Payload Monitor: Open the <xref href="payloadmonitor.xml"/> window. Only available for Middle Tier users.</li>
<note>Only the Payload Monitor or Query Monitor will show, depending on whether Middle Tier is enabled.</note>
	<li>Request Features: Open the <xref href="featurerequests.xml" /> system.</li>
	<li>Support Status: Opens the Support Status window to see if your office is currently signed up for <xref href="fees.html">Monthly Support</xref>.</li>
	<li>Update: Check for and download new versions of Open Dental. See <xref href="update.xml" />.</li>
	<li>About: Open the <xref href="aboutwindow.xml" /> window.</li>
</ul></p>
</div>
</div>
</body>

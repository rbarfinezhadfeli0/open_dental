# File: ./www.opendental.com/manual232/signupportalbasic.html
...
<img src="images/eservicesBasicView.png" width="915" height="969"/><p>This view opens by default when there is only one location / clinic. <div class="Note">Note: <ul>
...
<img src="images/signupBasicTop.png" width="808" height="97"/><p class="MarginBottomZero"></p>
...
<ul class="MarginBottomGap">
<li><b>Country Code</b>: Used for <a href="textintegratedusage.html">Texting</a>. Determines texting phone number and per message fees. Select the country the practice is in. If the needed country is not listed, contact Open Dental Support to see if the service is available.</li>
...
<li>In rare cases, your telecomm provider may not support landline texting. Additionally, your telecomm provider may change suppliers at some time after you have signed up. This may result in your number no longer being available for this service, as not all suppliers support landline texting. In cases like these we can provide your practice with an alternate number utilizing a local area code.</li>
</ul>
</div>
</p>
</div>

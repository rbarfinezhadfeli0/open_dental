# File: ./www.opendental.com/manual232/definitionspaymenttypes.html
...
<img src="images/definitionsPaymentTypes.png" width="816" height="526"/><p>The Payment Types definition determines the list of patient payment type options available in the <a href="payment.html">Edit Payment</a> window.</p>
...
<img src="images/definitionEditPayTypes.png" width="433" height="247"/><p class="MarginBottomZero"></p>
...
<p><div class="Note">Note: If a <i>Cash</i> payment type does not exist, one will be automatically created for use in <a href="depositslip.html">Deposit Slips</a>. If you have been using a different payment type to track cash payments, you must change them to the <i>Cash</i> payment type in order to track money payments in a deposit.</div>
</p>
</div>
</div>
</body>

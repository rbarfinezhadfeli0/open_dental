# File: ./www.opendental.com/manual232/searchmanual.html
        ...
        <div class="TopBar">
            ...
            <div class="TopBarLinks">
                <div class="TopBarTitle">Manual<select id="SelectVersion" class="TopBarVersionDrop" onchange="location = this.options[this.selectedIndex].value;
						...
						<option value="https://www.opendental.com/manual243/searchmanual.html">v24.3</option>
						...
						<option value="https://www.opendental.com/manual232/searchmanual.html" selected>v23.2</option>

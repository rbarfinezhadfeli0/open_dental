# File: ./www.opendental.com/site/mysqlusermanager.html
...
<body onload="BodyLoaded('mysqlusermanager','databasemanagementsystems','advancedtopics','documentation')">
	<nav class="LeftTree">
...
<p><div class="Note">Note: The <a href="../autoLogin.aspx%EF%B9%96ReturnUrl=%EA%A4%B7help253%EA%A4%B7opendentalservice.html">Open Dental Service</a> and <a href="../autoLogin.aspx%EF%B9%96ReturnUrl=%EA%A4%B7help253%EA%A4%B7econnector.html">eConnector</a> must be reinstalled after using the MySQL User Manager to create or change a password for the user they are set up with. This is normally the 'root' user.</div>
</p>
		</div>
	</div>
</body>

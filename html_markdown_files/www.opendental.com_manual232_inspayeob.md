# File: ./www.opendental.com/manual232/inspayeob.html
...
<img src="images/claimPaymentEOB.png" width="915" height="657"/><p>Alternatively, this window opens when clicking <b>OK</b> to finalize a payment from the <a href="editinspayment.html">Edit Insurance Payment</a> window. </p>
...
<li><b>Up/Down Arrows</b>: Highlight a claim and click to move in the grid.</li>
<li><b>Refresh</b>: Update the claims in the grid to remove any claims that have been finalized or add any claims received since the window was opened.</li>
<li><b>Detach</b>: Select claim(s) not associated with payment and click to disassociate from the payment. <ul>
...
<li><b>Total Payments</b>: The total of all claim payments associated with the current insurance payment. This should match the <i>Amount</i>.</li>
</ul>
...
<p>Click <b>OK</b> to finish finalizing an insurance payment or save changes.</p>
<h2>Finalizing Insurance Payments from Manage Module</h2>
<p>When finalizing a Batch Insurance Payment using the <b>Batch Ins</b> button from the Manage Module (see <a href="claimpaymentbatch.html">Batch Insurance Payment</a> for detailed instructions), the window in the screenshot below is displayed. Fields described above are the same, additional fields are described below. </p>
<img src="images/claimbatchattach.png" width="915" height="657"/><p><b>Attach</b>: Select a claim from the All Oustanding Claims Grid and click to attach to the <a href="claimpaymentbatch.html">Batch Insurance Payment</a>. </p>
...
<li>Payment: Total unfinalized payment amount of the claim. Claims that haven't been received have a payment of 0. If there is a payment amount, the claim has been received, but not attached to a payment.</li>
</ul>
<p><b>Close</b>: Click to exit the window. Changes are saved.</p>
<p></p>
</div>
</div>
</body>

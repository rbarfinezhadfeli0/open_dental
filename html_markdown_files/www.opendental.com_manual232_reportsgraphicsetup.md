# File: ./www.opendental.com/manual232/reportsgraphicsetup.html
...
<ul class="MarginBottomGap">
<li><b>Included Production Sources:</b> The production sources to consider when generating a Production report. Options include Completed Procs (Procedures), Adjustments, and Write-offs.</li>
...
<p class="MarginBottomZero"><b>Display:</b> The X axis (quantity). Options vary depending on the graph type. </p>
<ul class="MarginBottomGap">

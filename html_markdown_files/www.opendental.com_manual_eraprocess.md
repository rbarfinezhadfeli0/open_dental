# File: ./www.opendental.com/manual/eraprocess.html
...
<p><div class="Note">Note: If a claim attached to the ERA is split, the claim must be detached from the ERA in order to properly finalize payment. For detailed instructions, follow the Detaching a Claim steps on <a href="era835workflow.html">ERA Workflow</a>.</div>
</p>

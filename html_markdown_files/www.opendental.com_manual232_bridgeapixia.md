# File: ./www.opendental.com/manual232/bridgeapixia.html
...
<img src="images/bridgeApixia.png" width="778" height="598"/><p>Apixia is a digital imaging software. Website: <a href="http://www.apixia.net/html/front/bin/home.phtml" target="_blank">http://www.apixia.net/html/front/bin/home.phtml</a>.</p>
...
<p>Example File:</p>
<p><p class="codeblock">[Patient]</p><p class="codeblock">ID=17</p><p class="codeblock">Gender=Male</p><p class="codeblock">First=Mickey</p><p class="codeblock">Last=Mouse</p><p class="codeblock">Year=2008</p><p class="codeblock">Month=2</p><p class="codeblock">Day=24</p><p class="codeblock">[Dentist]</p><p class="codeblock">ID=doc1</p><p class="codeblock">Password=digirex</p></p>
...
<img src="images/bridgeApixiaServer.gif" width="774" height="526"/></div>
</div>
</body>
</html>```

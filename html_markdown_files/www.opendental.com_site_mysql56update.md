# File: ./www.opendental.com/site/mysql56update.html
...
<body onload="BodyLoaded('mysql56update','mysql','databasemanagementsystems','advancedtopics','documentation')">
	<nav class="LeftTree">
...
<br><div class="Note">Note: We recommend <a href="../autoLogin.aspx%EF%B9%96ReturnUrl=%EA%A4%B7help253%EA%A4%B7update.html">Updating</a> Open Dental to the latest stable version prior to upgrading to MySQL 5.6</div>
<br><br><p class="MarginBottomZero"></p>
<ol class="MarginBottomGap">
<li>All users need to be out of the Open Dental program. <a href="../autoLogin.aspx%EF%B9%96ReturnUrl=%EA%A4%B7help253%EA%A4%B7shutdown.html">Shutdown Workstations</a> all workstations from Open Dental.</li>
...
<li>If this window is accidentally skipped, run the Optimize tool from the <a href="../autoLogin.aspx%EF%B9%96ReturnUrl=%EA%A4%B7help253%EA%A4%B7databasemaintenancetools.html">Database Maintenance Tools Tab</a>.</li>
</ul>
</li>
</ol>
		</div>

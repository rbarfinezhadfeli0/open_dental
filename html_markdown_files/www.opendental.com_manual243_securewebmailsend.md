# File: ./www.opendental.com/manual243/securewebmailsend.html
...
<img src="images/webMailEdit.png" width="782" height="435"/><p>WebMail is a secure method of sending messages to a patient or <a href="authrep.html">Authorized Representatives</a>. Any user can compose a WebMail, but only a provider can send a WebMail.</p>
<p>Alternatively, another option for sending secure messages is the <a href="secureemailsetup.html">Secure Email</a> feature. </p>
...
<p><b>Preview</b>: Click the Preview button to view the webmail message before sending. <br/><img src="images/secureWebMailText.png" width="704" height="333" class="ImageInParagraph"/></p>
<p><b>Delete</b>: Click to delete the message. </p>
<p><b>Send</b>: Click to send the message. If the From provider is logged-on to Open Dental, the message is sent. If another user is logged-on, the provider's password is required. Enter the password, then click OK.<br/><img src="images/secureWebMailPwd.png" width="451" height="152" class="ImageInParagraph"/></p>
...
<p>Providers can view WebMail responses in the <a href="emailinbox.html">Email Client</a>.<p class="codeblock"></p></p>

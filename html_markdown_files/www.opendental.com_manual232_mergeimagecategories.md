# File: ./www.opendental.com/manual232/mergeimagecategories.html
...
<img src="images/mergeImageCats.png" width="631" height="276"/><p>Merging image categories logs an entry in the <a href="audittrail.html">Audit Trail</a>.</p>
 To merge Image Categories: <p class="MarginBottomZero"></p>
<ol class="MarginBottomGap">
<li><b>Image Category to merge into</b>: Click <b>Change</b> to select the Image Category to keep.</li>
<li><b>Image Category to merge from</b>: Click <b>Change</b> to select the Image Category to remove. </li>
<li> Click <b>Merge</b> to combine the categories. A warning prompts you to confirm. </li>
<br/><img src="images/mergeImageCatsConfirm.png" width="376" height="133" class="ImageInParagraph"/><li>Click <b>Yes</b> to continue.</li>
</ol>

# File: ./www.opendental.com/manual232/ccdws.html
...
<li>Enter the Service User Account and password. This is the user the service is being installed to. Then click <b>Next</b>.  <img src="images/ccdws6.gif" width="499" height="387"/><p><div class="Note">Note:  Domain, user, and password must be entered correctly for the service to install. If not using a domain, enter the server name instead (e.g., server\user or .\user). </div>
</p>
</li>
...
<li>Contact Open Dental Support for an updated CCDWS.ini configuration file.</li>

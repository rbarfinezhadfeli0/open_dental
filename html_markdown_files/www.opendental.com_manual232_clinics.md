# File: ./www.opendental.com/manual232/clinics.html
...
<img src="images/clinicsMainMenu.png" width="493" height="206"/><p>The Clinics feature keeps information separated by clinic / location.</p>
<p>Use this menu to select the clinic. Only clinics the logged-on user has access to are listed as options. To set the default Main Menu clinic when logging on, see <a href="miscsetup.html">Miscellaneous Setup</a>, <i>Track Last Clinic by</i>.</p>
<p><div class="Note">Note: When there are more than 30 clinics, there is no option in the Main Menu to show hidden Clinics.</div>
</p>
...
<p><b>Patients with No Assigned Clinic</b>: <br/> To find patients with no assigned clinic, run the <a href="databasemaintenance.html">Database Maintenance</a> tool and check results for PatientsNoClinicSet. If patient's are found, then manually assign a default clinics. If needed, contact Open Dental Conversions for a service to associate clinics</p>

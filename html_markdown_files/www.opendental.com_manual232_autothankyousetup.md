# File: ./www.opendental.com/manual232/autothankyousetup.html
...
<p>When using eConfirmations and Web Forms, this message can include the [NewPatWebFormURL] tag for patients to fill out forms online. If using the tag, set up the New Patient URL in <a href="automatedmessagingpreferences.html">Automated Messaging Preferences</a>. This is required for messages to send. </p>
...
<li>To enable Auto Thank-You message, click <b>Activate Auto Thank-You</b>. The Auto Thank-You row will display in green with a status of <i>Active</i>. </li>
<li>To disable Auto Thank-You messages, click <b>Deactivate Auto Thank-You</b>. The Auto Thank-You row will display in red with a status of <i>Inactive</i>.</li>
</ul>
<p class="MarginBottomZero">New Patient Thank-You Messages </p>
<ul class="MarginBottomGap">
<li>To enable New Patient Thank-You messages, click <b>Activate New Pat Thank-You</b>. The New Pat Thank-You row will display in green with a status of <i>Active</i>. </li>
<li>To disable New Patient Thank-You messages, click <b>Deactivate New Pat Thank-You</b>. The New Pat Thank-You row will display in red with a status of <i>Inactive</i>.</li>
</ul>

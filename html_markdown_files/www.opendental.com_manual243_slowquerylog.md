# File: ./www.opendental.com/manual243/slowquerylog.html
...
<title>Open Dental Software - Slow Query Log Tool</title>
...
<ul class="MarginBottomGap">
<li><b>Grade</b>: An evaluation of how bad the slow query log is. It is based off the average of small to medium sized offices.  <ul>
<li>If the grade is A or B, the slowness is likely not related to the queries. Check the worst queries regardless. </li>
<li>If the grade is C, the slowness may be related to the queries. Check the worst queries or escalate if unsure. </li>
<li>If the grade is D or F, the slowness is likely related to the queries. Check the worst queries, third party queries, and the tests below.</li>
</ul>
</li>

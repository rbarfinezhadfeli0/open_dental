# File: ./www.opendental.com/manual232/signupportaladvanced.html
...
<img src="images/eServicesAdvancedView.png" width="915" height="542"/><p>This view opens by default when there are multiple locations/clinics.</p>
...
<li>For Open Dental Cloud users, this window will open in a new web browser session.</li>
</ul>
</div>
</p>
...
<li>Totals: As eServices are selected, the total $ amounts will update to reflect new charges.</li>
</ul>
</li>
<li>Yellow highlight: eClipboard and Mobile will highlight in yellow if <a href="mobilesettings.html">Mobile Settings</a> for the clinic are incomplete. </li>
</ul>
<p><b>Save</b>: Apply eService changes. Charges will be reflected in the practice's next statement. A warning will display if Mobile Settings for a clinic are not set up and eClipboard or Mobile is selected.</p>
</div>
</div>
</body>
</html>```

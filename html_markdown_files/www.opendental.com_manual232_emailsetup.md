# File: ./www.opendental.com/manual232/emailsetup.html
...
<img src="images/emailsetup.png" width="912" height="390"/><p>Alternatively, in the <a href="emailinbox.html">Email Client</a>, in the top menu, click Setup.</p>
...
<p class="MarginBottomZero"><b>Email Addresses</b>: A list of email addresses that can be used by all staff members (e.g. general practice, clinic, or group email addresses). </p>
...
<li>User: The user associated with the email address.</li>
<li>Default: The email marked X is the default <i>From</i> email for outgoing emails.</li>
<li>Notify: The email marked X is the <i>From</i> email used to send secure WebMail notifications to patients. </li>
</ul>
<p>Double-click to <a href="emailaddressedit.html">Edit Email Address</a>.</p>
...
<br/><br/><p><b>Add</b>: Add a new email address that can be used by all staff members. </p>
<p><b>Inbox Receive Interval</b>: Set the time, in minutes, to automatically check for and download new emails using <a href="opendentalservice.html">Open Dental Service</a>. Five minutes is the default.</p>
...
<ul class="MarginBottomGap">
<li>Checked: Include the opt-out statement at the bottom of all eService emails. The opt-out statement cannot be edited.</li>
<li>Unchecked: Do not include the opt-out statement in eService emails. When unchecked, users receive a warning that the opt-out statement is required by US law. Click <b>OK</b> to continue. </li>
</ul>
...
<li>When a patient emails a response to <i>unsubscribe</i>, they are not automatically removed from an eService email list. To stop sending them eService emails, remove their email address on <a href="patientedit.html">Edit Patient Information</a>.</li>
<li>If a patient has unsubscribed from eService emails, their email address must be manually entered for future non-eService emails..</li>
</ul>
</div>
</p>

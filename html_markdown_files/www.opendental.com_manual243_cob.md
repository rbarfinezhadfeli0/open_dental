# File: ./www.opendental.com/manual243/cob.html
...
<ol class="MarginBottomGap">
<li>The amount that it would have paid in the absence of any other coverage.</li>
<li>The patient's portion for the primary plan.</li>
</ol>
<p class="MarginBottomZero">For example, on a $100 procedure, primary might pay $80 (80% of its allowed fee). </p>
<ul class="MarginBottomGap">
...
<p><b>Secondary Medicaid:</b> Secondary reduces what they pay by what primary pays. The estimated patient portion becomes a write-off for the primary insurance. This rule is only considered when a plan is secondary (Order = 2). Additional plans (e.g., tertiary) use Standard COB logic. Only use this rule when allowed to bill Medicaid as secondary.</p>

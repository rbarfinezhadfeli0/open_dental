# File: ./www.opendental.com/manual232/claimpaymentsupplemental.html
...
<p>Supplemental payments can also be created using the <b>To Supplemental</b> button. See Pending Payment section in <a href="claimedit.html">Claim</a>.</p>
...
<li>Highlight the procedure line items the supplemental payment applies to. <ul>
...
<li>Click <b>OK</b>.</li>
<li>On the Edit Claim window, click <b>This Claim Only</b> if finalizing a single claim, or <b>Batch</b> if finalizing for a batch payment. </li>
<li>Enter the amount and verify the attached claim(s). See <a href="claimpayfinalize.html">Finalize Insurance Payment</a>.</li>
</ol>
<p>Once created, supplemental payments display as an additional line item in the grid of procedures with the Status of <i>Supp</i>.</p>
...
<li>If a write-off was entered on another payment line, users only need to enter the adjustment amount, not the full write-off amount (e.g., if the write-off was originally entered as 40, but should have only been 30, only enter the difference of -10). </li>
</ul>
</li>
<li>Click <b>OK</b>.</li>
</ol>
...
<p>Open the Income Transfer Manager and click <b>OK</b> to re-transfer any remaining unallocated claim payments.</p>
</div>
</div>
</body>
</html>```

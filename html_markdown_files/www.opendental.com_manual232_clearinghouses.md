# File: ./www.opendental.com/manual232/clearinghouses.html
...
<img src="images/clearinghouses.png" width="840" height="562"/><p>Clearinghouses are listed alphabetically. Click <b>Add</b> to create a clearinghouse that isn't listed. Double-click an existing clearinghouse to enter settings.</p>
...
<h2>Set Default</h2>
<p>Determine the default clearinghouse for Dental, Medical, and Eligibility.</p>
<img src="images/clearinghouseSetDefault.png" width="112" height="125"/><p class="MarginBottomZero"></p>
<ul>
...
<img src="images/clearinghouseAutomaticReportSettings.png" width="585" height="127"/><p class="MarginBottomZero"><b>Receive Reports by Service:</b> Determines the method used to receive reports.  </p>
...
<li><a href="eclaimswebmd.html">Change Healthcare E-Claims</a> - Formerly Emdeon, WebMD, Envoy.</li>
...
<ul class="MarginBottomGap">
<li><a href="eclaimsemdeonmedical.html">Change Healthcare Medical E-Claims</a></li>
...
<ul class="MarginBottomGap">
<li><a href="itrans20.html">ITRANS 2.0</a> - Dentists only.</li>
<li><a href="claimstream.html">Claimstream</a> (TELUS / CCDWS) - Hygienists only.</li>
...
<p>For troubleshooting, see <a href="eclaimserrors.html">Clearinghouse Error Messages</a>.</p>
<p>For more technical information about what is sent in e-claims, see <a href="eclaimscomplexities.html">E-Claim Complexities</a>.</p>
<p>Some clearinghouses not listed above are not recommended. See <a href="../manual/thirdpartywarnings.html">Third-Party Warnings</a> for more information.</p>
</div>
</div>
</body>
</html>```

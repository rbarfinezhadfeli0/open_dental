# File: ./www.opendental.com/site/commandline.html
...
<body onload="BodyLoaded('commandline','advancedtopics','documentation')">
	<nav class="LeftTree">
...
<div class="Note">Note: Options set using a command line argument are not saved to <a href="../autoLogin.aspx%EF%B9%96ReturnUrl=%EA%A4%B7help253%EA%A4%B7freedentalconfig.html">FreeDentalConfig.xml</a></div>
...
<p><b>DynamicMode</b>: Indicates Open Dental should start with <a href="../autoLogin.aspx%EF%B9%96ReturnUrl=%EA%A4%B7help253%EA%A4%B7choosedatabase.html">Dynamic Mode</a> enabled. (Ex.: <span class="codeblock">DynamicMode=True</span>)</p>
...
<p>To prevent accidental updates of Open Dental when multiple locations potentially run different Open Dental versions, set an <i>Update Server</i> name in <a href="../autoLogin.aspx%EF%B9%96ReturnUrl=%EA%A4%B7help253%EA%A4%B7preferences.html">Preferences</a>. This computer will be the one and only computer that has permission to execute updates.</p>
...
<p><b>PatNum:##</b> (related, but not command line) Place "PatNum:##" on the Windows clipboard, and then click the <a href="../autoLogin.aspx%EF%B9%96ReturnUrl=%EA%A4%B7help253%EA%A4%B7patientselect.html">Select Patient</a> button. This will cause Open Dental to switch to that patient instead of bringing up a list of patients.</p>

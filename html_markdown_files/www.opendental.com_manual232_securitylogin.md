# File: ./www.opendental.com/manual232/securitylogin.html
...
<img src="images/securityLogOn.gif" width="542" height="398"/><p>To protect data and prevent misuse, every user should be required to log on with a unique user name and password, then log off when they leave the workstation. See <a href="security.html">Security</a> to set up user profiles and assign permissions.</p>
...
<p>Alternatively, if the <a href="securitysettings.html">Global Security Setting</a>, <i>Manually Enter Log On Credentials</i> is enabled, the Log On window will appear as shown below. Users must manually enter their user name to log in. The user list and filter will not be shown.</p>
<img src="images/securityLogOnManual.png" width="542" height="198"/><p></p>
...
<li>After five consecutive failed attempts to log on, a user will temporarily be locked out of the account for five minutes or until a user with Security Admin privileges manually unlocks the account. See <a href="securityunlockaccount.html">Unlock Account</a>.</li>
...
<img src="images/securityLogOff.gif" width="465" height="152"/><p class="MarginBottomZero"></p>
<ul class="MarginBottomGap">

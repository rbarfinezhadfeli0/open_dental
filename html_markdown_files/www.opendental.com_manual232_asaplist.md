# File: ./www.opendental.com/manual232/asaplist.html
...
<img src="images/asapList.png" width="915" height="464"/><p>The ASAP List can remain open while other areas of Open Dental are open. Use the list to identify patients and quickly notify them about available openings. Appointments can also be scheduled from here.</p>
...
<li><a href="../site/websched.html">Web Sched ASAP</a>: Send ASAP messages about available openings and allow patient to reschedule online.</li>
...
<p class="MarginBottomZero">There are 4 ways to place a patient on the ASAP List:  </p>
<ul class="MarginBottomGap">
...
<h2>Settings</h2>
<p class="MarginBottomZero">To narrow results on the Appointments or Unschedled Recalls tab, select other filter criteria then click <b>Refresh</b> to update. </p>
<ul class="MarginBottomGap">
...
<li><b>Code Range</b>: Only view appointments with specified procedures codes attached.</li>
</ul>
...
<ul class="MarginBottomGap">
<li><b>Sign up</b>: Sign up for <a href="../site/websched.html">Web Sched ASAP</a> and/or <a href="../site/textintegrated.html">Integrated Texting Feature</a>. See <a href="eservicessignup.html">eServices Signup</a>. Once Web Sched ASAP is turned on, Send/History buttons show instead.</li>
<li><b>Send</b>: Send is only an option when the ASAP List is accessed by right clicking on an available time slot in the Appointment schedule and select Text ASAP List. See <a href="webschedasap.html">Web Sched ASAP</a>.</li>
...
<img src="images/asapListApptTab.png" width="910" height="230"/><p class="MarginBottomZero">By default, the Appointments tab opens. This lists scheduled, unscheduled, planned, and broken appointments that have been marked ASAP.  </p>
<ul class="MarginBottomGap">
...
<ul class="MarginBottomGap">
<li><b>Start / End Date</b>: Determines which appointments list based on recall due date. Defaults to the current week.</li>
...
<ol>
<li>(Optional) In the ASAP List, highlight the patient(s) to send a text message to. <div class="Note">Note: If patients are selected before clicking Text, only those patients will be texted. If patients are not selected first, all patients with a wireless number are auto-selected.</div>
</li>
<li>Click Text. <br/><img src="images/webSchedASAPManualText.png" width="250" height="212" class="ImageInParagraph"/></li>
<li>Enter the date and time of the available appointment, then click OK. <br/><img src="images/webSchedASAPTextReview.png" width="387" height="439" class="ImageInParagraph"/></li>
...
<li>Click Send. A commlog is added to each patient's account.</li>
</ol>
</div>
</div>
</body>

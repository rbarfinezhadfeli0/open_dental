# File: ./www.opendental.com/manual243/advertisingselectpatients.html
...
<img src="images/advertisingSelectPat.png" width="915" height="450"/><p>Patients without an address are automatically filtered out of the list.</p>
<h2>User Query</h2>
...
<li><span class="codeblock">SET</span> statements cannot be used and cause an error.</li>
</ul>
</li>
<li><b>Favorites</b>: Click to select a query from <a href="queryfavorites.html">Query Favorites</a>. </li>
</ul>
<h2>Filters</h2>
<img src="images/advertisingSelectPatFilters.png" width="501" height="124"/><p class="MarginBottomZero"></p>
<ul class="MarginBottomGap">
...
<img src="images/advertisingSelectPatSet.png" width="915" height="253"/><p>The list of patients matching the filter criteria show. Select which patients should receive the communication.</p>
<p class="MarginBottomZero"></p>
<ul class="MarginBottomGap">
<li><b>Set All</b>: Mark all patients to send to. </li>
<li><b>Set Selected</b>: Set only the selected patients to send to. </li>
<li><b>Clear Selected</b>: Clear the Send list. </li>
<li><b>Clear All</b>: Clear all selected patients. </li>

# File: ./www.opendental.com/manual232/bridgeowandy.html
...
<img src="images/bridgeOwandy.png" width="778" height="598"/><p>Owandy is an imaging software. Website: <a href="http://www.owandy.com" target="_blank">www.owandy.com</a>.</p>
...
<p>This bridge launches Quick Vision using command line arguments, then passes some data to Quick Vision using Windows API calls. Open Dental passes the patient PatNum, last name, and first name to Quick Vision. Owandy must be open when you click the bridge button, or the patient will not load in Owandy.</p>
</div>
</div>
</body>
</html>```

# File: ./www.opendental.com/manual243/webschedexistingpatsetup.html
...
<img src="images/webschedExistingPatient.png" width="915" height="438"/><p>Web Sched Existing Patient allows current patients to schedule their appointment online. The office can determine which type of appointments a patient can schedule, what hours are available, what operatories are available, and other appointment criteria. Provider schedules must be created prior to utilizing Web Sched Existing Patient (see <a href="https://www.opendental.com/manual243/schedule.xml"/>).</p>
...
<p>Web Sched Existing Pat Appt Types must be created prior to utilizing Web Sched Existing Patient. Web Sched Existing Patient Appointment Types determine the reasons patients can select for their appointment, the procedures for the appointment, the appointment length, and the time pattern.</p>

# File: ./www.opendental.com/manual232/opendentalcloudbackups.html
...
<title>Open Dental Software - Open Dental Cloud Backups</title>
...
<table width="946" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td bgcolor="#FFFFFF" style="padding-left:15px; padding-top:20px; padding-right:15px; background-image: url(../open-dental/Back.jpg); background-repeat: repeat-x;">
	  <h1>Open Dental Cloud Backups</h1>
<p><a href="../site/opendentalcloud.html">Open Dental Cloud</a> performs automatic backups of the database and OpenDentImages folder.</p>
<p>Routine backups are made and stored according to the chart below. Backups are made at each frequency and are retained for the time listed. </p>
<p></p>
...
<th style="width:20%">Time Retained</th>
</tr>
<tr>
<td>Hourly</td>
<td>Incremental*</td>
...
<tr>
<td>Weekly (1st, 8th, 15th, &amp; 22nd of each month)</td>
<td>Full</td>
<td>Off Site</td>
<td>6 Months</td>
</tr>
...
<tr>
<td>Yearly (January 1st of each year)</td>
<td>Full</td>
<td>Off Site</td>
<td>3 Years</td>
</tr>
</table>
<br/><p class="MarginBottomZero"></p>
<ul class="MarginBottomGap">
<li>Incremental backups do not include the OpenDentImages folder.</li>
<li>Backup frequencies are subject to change.</li>
</ul>
<p>Copies of backups can be requested by contacting Open Dental support.</p>
</td>
  </tr>
	<tr>

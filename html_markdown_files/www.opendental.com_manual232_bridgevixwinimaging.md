# File: ./www.opendental.com/manual232/bridgevixwinimaging.html
...
<div class="Note">Note: VixWin will not recognize UNC paths. Use mapped drive letters.</div>
<br/><br/><h2>Troubleshooting</h2>
<p><b>VixWin crashes when using Windows 10 and opening VixWin via Open Dental.</b></p>
<p>Make sure the VixWin image drivers are updated to 3.6 or greater.</p>
<h2>Other VixWin Bridges</h2>
<p>If you currently use one of the VixWin bridges listed below, we recommend you contact us. </p>
<ul>
<li>VixWin (old)</li>
<li>VixWin (new)</li>

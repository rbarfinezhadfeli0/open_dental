# File: ./www.opendental.com/manual232/notes.html
...
<p>To customize the general note's color, create an alternate provider for the note (e.g. NOTE) and set the provider's color to something that makes sense in your office. Then select the NOTE provider on the Edit Appointment window for the note.</p>

# File: ./www.opendental.com/manual243/querymonitor.html
...
<img src="images/queryMonitor.png" width="915" height="397"/><p>This window can remain open in the background to allow monitoring during normal use of the program. Activity displayed is only from the instance of Open Dental from which it was launched. It does not allow you to monitor all queries being processed by the MySQL server.</p>
...
<li><b>Server</b>: Computer name of the server that received the monitored query. This may be the name of the database server, report server, or read-only server.</li>

# File: ./www.opendental.com/manual243/feesexport.html
...
<li>Select the location and file name and click <b>Save</b>. By default, it is saved as a text file in the <i>OpenDentalExports</i> folder. </li>
</ol>
...
<p>To change fees, open the saved file, make the changes, and then save the file. If making changes to import back into Open Dental, only code and fee changes are recognized. See <a href="feesimport.html">Fees Import</a> for instructions on importing any changes.</p>

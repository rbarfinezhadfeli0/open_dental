# File: ./www.opendental.com/manual232/portalhostedbyod.html
...
<img src="images/patientPortalSetup.png" width="572" height="658"/><p class="MarginBottomZero">Patient Portal is hosted by Open Dental and available to all customers on support. </p>
...
<ul class="MarginBottomGap">
<li><b>Customize URL</b>: Enter a custom URL that shows on printouts. Typically, this URL is a redirect back to the Patient Portal.<br/><img src="images/patientPortalCustomizeURL.png" width="465" height="152" class="ImageInParagraph"/></li>
<li><b>Hosted URL</b>: The patient portal URL generated by Open Dental and linked to the Registration Key. </li>
</ul>
...
<img src="images/patPortalEmail.png" width="547" height="262"/><p>The email address set as WebMailNotify in <a href="emailsetup.html">Email Setup</a> is used to send WebMail notifications.</p>

# File: ./www.opendental.com/manual243/bridgecamsight.html
...
<img src="images/bridgeCamsight.png" width="770" height="594"/><p>Camsight is a digital imaging software. This bridge is also used for Denttio. Website: <a href="http://denttio.com/" target="_blank">http://denttio.com/</a>.</p>
...
<p>Camsight uses the patient number to identify selected patients. Open Dental sends the patient's birthdate, chart number (if selected), name, patient number, and SSN to Camsight. If the patient does not exist, a new patient record is created.</p>

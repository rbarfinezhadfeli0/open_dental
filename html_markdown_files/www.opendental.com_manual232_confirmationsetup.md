# File: ./www.opendental.com/manual232/confirmationsetup.html
...
<img src="images/confirmationSetup.png" width="874" height="398"/><p>This window is specific to confirmations sent manually (i.e. from the <a href="confirmationlist.html">Confirmation List</a> or <a href="appointments.html">Appointments Module</a>).</p>
...
<h2>Customize Message Text</h2>
<p>Double-click a row to edit the message text. </p>
<img src="images/confirmationlistMsgEdit.png" width="506" height="160"/><p>Enter the subject or message text. Insert variables as needed. </p>

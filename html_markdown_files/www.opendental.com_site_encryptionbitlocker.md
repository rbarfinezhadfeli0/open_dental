# File: ./www.opendental.com/site/encryptionbitlocker.html
...
<body onload="BodyLoaded('encryptionbitlocker','encryption','securitycomputers','computernetworksetup','documentation')">
	<nav class="LeftTree">
...
<p>Encrypted sectors in a BitLocker-protected drive are decrypted as they're requested from system read operations. BitLocker does not encrypt and decrypt the entire drive when reading and writing data. No unencrypted data is ever stored on a BitLocker-protected drive as blocks that are written to the drive are encrypted before they are written to the physical disk. For more information, see: <a href="https://learn.microsoft.com/en-us/windows/security/operating-system-security/data-protection/bitlocker/faq">Microsoft BitLocker FAQ</a></p>

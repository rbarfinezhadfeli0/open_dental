# File: ./www.opendental.com/manual232/emailerrors.html
...
<p><b>Error: Open Dental appears to have successfully sent email, but recipient never receives it. </b></p>
...
<p><b>Problem: In the Email Inbox or Progress Notes, email preview and message is showing in HTML code.</b></p>
...
<p><b>Email message cannot contain the URL [URL] as this is only allowed for eServices.</b></p>
...
<p>Solution: AOL may be requiring an app password that can be created in AOL Account Security. </p>
</div>
</div>
</body>
</html>```

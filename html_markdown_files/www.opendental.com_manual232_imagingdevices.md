# File: ./www.opendental.com/manual232/imagingdevices.html
...
<img src="images/imagingDevices.png" width="914" height="330"/><p>Add sensors to be used with the Capture button in the <a href="images.html">Imaging Module</a>.</p>
...
<p>Click Add to add a new device, or double-click a device to edit.</p>
<img src="images/imagingDeviceEdit.png" width="568" height="272"/><p class="MarginBottomZero"></p>
<ul class="MarginBottomGap">
<li><b>Description</b>: Enter a description for the device. Displays in the Imaging Module.</li>
...
<li>Twain Radiograph: Individual sensors. These sensors can still capture a series of images, but each image will be displayed before the next one is acquired. </li>
<li>Twain Multi: For use with sensors that cannot send individual images (e.g., phosphor plate systems, AT ScanX). Only groups of images are captured and displayed.</li>
</ul>
</li>

# File: ./www.opendental.com/manual232/alertcategories.html
...
<img src="images/alertCategories.png" width="883" height="388"/><p class="MarginBottomZero">A list of internal groupings displays on the left. Customized alert categories show on the right. Only Custom alert categories can be edited. </p>
<ul class="MarginBottomGap">
<li>All: All <a href="alerts.html">Alerts</a>.</li>
<li>eServices: Alerts about <a href="../site/eservices.html">eServices</a>.</li>
<li>eRx: Alerts about <a href="dosespotalerts.html">DoseSpot Alerts</a>.</li>
<li>Supplemental Backups: Alerts about <a href="supplementalbackups.html">Supplemental Backups</a></li>
</ul>

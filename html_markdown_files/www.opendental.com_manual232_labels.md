# File: ./www.opendental.com/manual232/labels.html
...
<img src="images/labelButton.png" width="736" height="63"/><p>Labels can be printed one at a time or by sheet. They can be customized in <a href="sheets.html">Sheets</a>.</p>
...
<li>If no custom labels have been created, all internal label sheet options will show.</li>
<li>If custom labels have been created, only the custom labels will show.</li>
</ul>
...
<p>To print labels one at a time, use a label printer. Label printers may require some additional installation outside of Open Dental. Once the label printer is set up as a Windows printer, go to the <a href="printersetup.html">Printer Setup</a> on the workstation where users will be printing labels. Set labels to print on the label printer with no prompt.</p>
...
<li>On the <a href="claimsend.html">Insurance Claims</a> window, highlight the claims, then click <b>Labels</b>. Single labels will print for those carriers.</li>
</ul>
...
<p>See <a href="https://support.office.com/en-US/article/Create-and-print-labels-for-a-mass-mailing-8037DBA1-7E3A-40AF-8CC0-F25EE4130241">https://support.office.com/en-US/article/Create-and-print-labels-for-a-mass-mailing-8037DBA1-7E3A-40AF-8CC0-F25EE4130241</a>.</p>
</div>
</div>
</body>
</html>```

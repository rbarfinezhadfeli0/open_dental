# File: ./www.opendental.com/manual232/eclaimsrenaissance.html
...
<img src="images/eClaimsRenaissance.png" width="915" height="687"/><p>Renaissance is an e-claims clearinghouse solution that uses the Remote Lite software. Visit <a href="https://vynedental.com/" target="_blank">www.vynedental.com</a> to learn more about their services.<br/> Other names for Renaissance include Vyne Dental &amp; Dental Hero. </p>
<p>New Vyne Dental users should enable the <a href="eclaimsvyne.html">Vyne Dental E-Claims</a> clearinghouse instead. </p>
<p>Vyne Dental is moving all existing Renaissance users to Vyne Dental. If claims stop sending, contact Open Dental Support for assistance moving to Vyne Dental. An Open Dental update may be required. </p>
<h2>Open Dental Setup</h2>
<p>Contact Renaissance to set up an account and install the RemoteLite program. </p>
<p class="MarginBottomZero">Set up using above screenshot as a reference, then click OK to save. </p>

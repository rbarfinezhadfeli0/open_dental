# File: ./www.opendental.com/manual232/mountinfo.html
...
<img src="images/mountInformation.png" width="627" height="464"/><br/><p class="MarginBottomZero">Edit the information for the selected mount. </p>
...
<li><b>Edit Layout</b>: Click to edit the selected mount only. Opens the Edit Mount Layout window (see below) where the mount can be edited and items can be added or removed. See below for details.</li>
...
<p>Click <b>Edit Layout</b> to add or remove mount items. </p>
<img src="images/editMountLayout.png" width="915" height="413"/><p>For details on editing a mount, see <a href="mountdefinitions.html">Mount Definitions</a>.</p>
</div>
</div>
</body>
</html>```

# File: ./www.opendental.com/site/mysqlinnodb.html
...
<body onload="BodyLoaded('mysqlinnodb','databasemanagementsystems','advancedtopics','documentation')">
	<nav class="LeftTree">
...
<p><b>Open Dental Backup Tool (Hot Method)</b>: Use the built-in <a href="../autoLogin.aspx%EF%B9%96ReturnUrl=%EA%A4%B7help253%EA%A4%B7backuptool.html">Backup Tool</a> to routinely make backups of the entire database. The tool can be used for backups only, not restores.</p>
...
<p><b>Network Path Supplemental Backups (Hot Method)</b>: The <a href="../autoLogin.aspx%EF%B9%96ReturnUrl=%EA%A4%B7help253%EA%A4%B7supplementalbackups.html">Supplemental Backups</a> utility in Open Dental can be used to create an automated, encrypted, zipped, database dump in a network or local location nightly. Network Path Supplemental Backups are a complete copy of a database but are not recommended to be relied upon as the primary backup method. The OpenDentalEConnector service performs this backup once every 7 days.</p>
...
<p><b>Alternative InnoDB Backup and Restore Methods Using Third-Party Software (Varies)</b>: A backup and restore can also be achieved using 3rd-party software such as MySQL Workbench or SQLYog. Methods may be Hot or Cold and can vary by software. Please reference their documentation for more information. Also see: <a href="../autoLogin.aspx%EF%B9%96ReturnUrl=%EA%A4%B7help253%EA%A4%B7backupsonline.html">Online Backups</a>.</p>
		</div>
	</div>
</body>
</html>```

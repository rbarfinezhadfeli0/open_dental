# File: ./www.opendental.com/manual232/bridgedemandforce.html
...
<p>The bridge will write out an xml file with all patient data. Use Demandforce to sync the xml file.</p>
</div>
</div>
</body>
</html>```

# File: ./www.opendental.com/manual232/carecredittransactions.html
...
<img src="images/careCreditTransactions.png" width="915" height="368"/><p class="MarginBottomZero">Alternatively, in the <a href="carecreditaction.html">CareCredit Action</a> window, click <b>Transactions</b>. </p>
...
<h2>Batch Transactions Tab</h2>
<p>The Batch Transactions Tab shows the status of batch quickscreens in a date range. </p>
<img src="images/careCreditTransactionBatch.png" width="915" height="396"/><p><b>Status</b>: Sort by transaction status. </p>
...
<img src="images/careCreditTransactionErrors.png" width="915" height="413"/><p>Highlight a patient, or click <b>All</b> to select all, then acknowledge the errors. Acknowledging an error removes it from the list, but does not clear it from Open Dental <a href="alerts.html">Alerts</a>.</p>

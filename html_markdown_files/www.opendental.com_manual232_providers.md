# File: ./www.opendental.com/manual232/providers.html
...
<li>Under Move Patients, click <b>[...]</b>. Select the new primary provider and click OK.</li>
...
<p class="MarginBottomZero"><b>Reassign by most-used provider</b>: Quickly change a patient's primary provider to the provider who has completed most of the patient's procedures. This process will look at all patients who have the selected provider(s) as their primary provider. If a different provider has performed more of their completed procedures, that provider will be assigned as their new primary provider. The <i>Patient Primary Provider Edit</i> permission is also required. </p>
<ol class="MarginBottomGap">
<li>Highlight the provider(s) to review.</li>
<li>Click <b>Reassign</b>.</li>
<li>A confirmation message will show. Click <b>OK</b> to proceed and search for possible reassignments.</li>
<li>A message will show indicating how many possible reassignments have been identified. Click <b>OK</b> to reassign the patients to the most-used provider. Click <b>Cancel</b> to abort.</li>
</ol>
<div class="Note">Note: If multiple providers share an equal number of completed procedures, the most recently used provider will take precedence.</div>
<br/><br/><h2>Reorder the Provider List</h2>

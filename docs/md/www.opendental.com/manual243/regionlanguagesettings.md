...
* Region and Language on the workstations should match the setting *Language and region used by program* found in [Preferences](preferences.html).
...
![](images/currencyDecimalSettings.png)

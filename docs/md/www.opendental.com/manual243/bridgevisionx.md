...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **VisionX**.

![](images/bridgeVisionx.png)

VisionX is an imaging software. Website: <http://www.airtechniques.com>.

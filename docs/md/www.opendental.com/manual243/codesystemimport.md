...
![](images/ehrCodeSystemImport.png)
...
* If there are licensing agreements, they are displayed prior to import. Click **OK** to agree to licensing terms and proceed; Exit [X] the window to cancel the import.
...
| [LOINC](loinc.html) | Logical Observation Identifiers Names and Codes | 72,624 codes 15.5 MB | CQMs, medical laboratory orders, radiology orders, clinical summaries, summaries of care, syndromic surveillance, vaccines (validation) |
...
| [SNOMED CT](snomedct.html) | Systemized Nomenclature of Medication Clinical Terms | 2,720,609 codes 131 MB | problems (every problem should be attached to a SNOMED CT code), CQMs, procedures (medical tab) |

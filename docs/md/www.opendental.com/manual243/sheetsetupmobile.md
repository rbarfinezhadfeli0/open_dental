...
![](images/youtubeLogo.png) See our video on Mobile Web Forms: [Web Forms Tutorial](https://youtu.be/vxTM-m3JHBU).
 Sheets enabled with mobile layout, excluding Exam Sheets, can be used in [eClipboard](../site/eclipboard.html) and [ODTouch](../site/odtouch.html). Exam Sheets with a mobile layout can be used in ODTouch only.

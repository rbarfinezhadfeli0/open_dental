...
PT Dental offers paperless technologies. Website: [www.gopaperlessnow.com](http://gopaperlessnow.com/). This functional 2-way bridge handles Registration Forms.

First enable PT Dental:

1. In Program Links, double-click on **PT Dental from gopaperlessnow.com**.
...
1. In Program Links, double-click on **PT Dental update (second button)**.
2. Check the **Enabled** box.
3. If using clinics, click **Hide Button for Clinics**. Select which clinics the button should display on.
4. Click Save.
...
2. Click *PT Dental* to send the patient data to PT Dental. This ensures both programs have the same patient data.
   * Also use the PT Dental button any time the patient needs opened in PT Dental.
3. If the patient fills out a form in PT Dental, whether online or in the office, certain patient data may need to be updated. This includes demographics, insurance, referrals, and med alerts. Use the button in PT Dental to send this information to Open Dental.
   * A message displays confirming that the transfer was successful.

...
![](images/patientEditPublicHealth.png)
...
![](images/patientEditRaceEthnicity.png)
...
* Click **Save** to keep all selections.
...
![](images/patientEditRaceEthnicityEHR.png)
...
**Site (or Grade School)**: Click **[...]** to select a site from the [Site List](sites.html).

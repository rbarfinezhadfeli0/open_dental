...
1. Add the new server to [Replication Setup](replicationservers.html). This step can alternatively be completed at the end of setup.
2. Shutdown all workstations. [Shutdown Workstations](shutdown.html)

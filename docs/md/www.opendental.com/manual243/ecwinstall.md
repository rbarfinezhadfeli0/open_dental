...
To install Open Dental on a client workstation properly, [eClinicalWorks](bridgeeclinicalworks.html) customers need three items.
...
2. The Setup.exe file for the current Open Dental version. It is located in the 'Setup Files' subfolder of the shared [A to Z Folder](atozfolder.html) used by Open Dental (often **\\Server\OpenDentImages\SetupFiles**). If you cannot locate the correct setup file, contact Open Dental.

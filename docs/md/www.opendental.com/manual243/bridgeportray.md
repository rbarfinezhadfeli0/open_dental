...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **PORTRAY from Surround Medical Systems**.

![](images/bridgePortray.png)

PORTRAY is an imaging software. Website: [www.portrayxray.com](https://portrayxray.com/).

...
In the [Supply Inventory](supplyinventory.html) window, click **Equipment**.
...
Click  **Add** to create a new equipment item or double-click an existing item to edit.

![](images/equipmentEdit.png)
...
**Delete**: Permanently remove the item from the Equipment list.

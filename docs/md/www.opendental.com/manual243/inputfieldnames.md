...
See [Sheet Input Field](sheetsinputfield.html).

Input Fields are [Sheet Field Types](sheetsaddelements.html) where patients input information when filling out forms. Most fields are self-explanatory. Fields that need additional detail have a description noted. The available input fields vary by sheet type.

| Input Text Field Name | Description |
| --- | --- |
| notes | Available for:  * Referral Slips. Input notes specific to the referral source. * Rx. Not used. * Lab Slips. |

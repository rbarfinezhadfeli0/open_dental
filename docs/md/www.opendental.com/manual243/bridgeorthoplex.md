...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **OrthoPlex from Dentsply GAC.**

![](images/bridgeOrthoPlex.png)

OrthoPlex is an ortho imaging program.

...
Users must have the *Ortho Chart Edit (full)* or *Ortho Chart Edit (same user, signed)* [Permission](permissions.html) to make changes or additions to the Ortho Chart. Some buttons are disabled when the user does not have either permission.
...
* Create [Patient Fields](custompatientfields.html). This information is displayed in the Patient Felds section.
* To show [Auto Ortho](orthoauto.html) information, enable the preference, *Show Auto Ortho information in the Ortho Chart*.
* Define Ortho Chart tabs in [Ortho Chart Setup](orthochartsetup.html).
...
The Ortho Info grid displays patient [Auto Ortho](orthoauto.html) information. Only shows if the preference, *Show Auto Ortho information in the ortho chart* is enabled.
...
* **Signature**: Enter the provider [Electronic Signature](electronicsignatures.html). Validity of electronic signatures is determined by Open Dental.

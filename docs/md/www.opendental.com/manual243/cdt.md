...
The ADA license allows us to include the ADA (CDT) [Procedure Codes](procedurecodes.html) for distribution within the United States only. As required by the ADA CDT content license, every United States customer of Open Dental Software must fill out and return a [CDT Compliance Form (PDF)](../resources/cdtcompliance.pdf). This form discloses in writing the number and location of all end-user sites that use the software, and thus the CDT codes.

To download new CDT codes, see [Procedure Code Tools](procedurecodetools.html).

...
In the [Ensora eRx (formerly NewCrop eRx) / Prescription](newcrop.html) interface, click the **Tasks** tab. At the bottom is a Failed Prescriptions list.
...
![](images/newCropFailedRxTask.png)
...
1. In the Ensora eRx window, Compose Rx tab, click the Edit dropdown.
2. Click **Detail**.
3. Scroll to the bottom. In the *Prescription History* section, any Failure is noted in the status column.
   * An *Action* of *ERx* is required for a prescription to be marked as *Failure*. Printed or Faxed prescriptions are not marked as *Failure*.
...
1. Click **Report Missing Rx.**.
![](images/newCropReportMissingRx.png)2. Fill in the two required fields:
![](images/newCropMissingRxReport.png)3. Click **Send** to report it. When an explanation or outcome has been determined for the missing prescription, an Open Dental eRx team member will notify the office via phone.
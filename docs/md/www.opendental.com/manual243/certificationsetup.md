...
In [Certifications](certifications.html), click **Setup**.

![](images/certificationSetup.png)

There are three steps to set up Certifications.

1. Create Certification Categories. See [Definitions: Certification Categories](definitionscertificationcats.html).
2. Add [Employees](employees.html) and to use the Report To filter, assign a *Reports To* for each employee.
...
![](images/certificationEdit.png)

* **Description**: Name of the certification.
* **Wiki Page**: (optional) Enter the name of the corresponding [Wiki](wiki.html) page for the certification.

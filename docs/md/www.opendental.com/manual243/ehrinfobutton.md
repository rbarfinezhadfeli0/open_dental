...
The Info Button ![](images/infobutton.gif) gives a direct link to MedLine Plus where you can find additional clinical information. The Info Button only shows for users with the *Show i*[CDS permission](ehrcdspermissions.html).

Click the Info Button.

![](images/ehrinfoPortal.gif)

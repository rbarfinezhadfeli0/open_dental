...
2. Verify the **Path of file to open**.
   ...
   * Sidexis 4 is different than Sidexis XG. To use the latest update for Sidexis 4, change the path of file to open to the correct exe.
...
Patients must have a valid birthdate to launch the bridge.

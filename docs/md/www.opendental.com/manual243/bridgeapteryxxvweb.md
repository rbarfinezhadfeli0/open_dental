...
Apteryx XVWeb is a web-based imaging application. Website: <http://www.apteryx.com/xvweb>.

To activate the bridge:

1. Check the **Enabled** box.
2. Double-click a row in **Additional Properties** to change settings.
   1. Use the PatNum (enter 0) or ChartNum (enter 1) as the patient ID.
   2. Enter the custom XVWeb URL.
...
The Apteryx XVWeb application may require login credentials each time the bridge is launched.
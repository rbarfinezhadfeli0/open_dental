...
* **Sections**: Check the boxes next to the information to include. Click All to select all sections; click None to clear all selections. For a detailed explanation of all areas, see [Continuity of Care Document (CCD)](ehrccd.html). If you uncheck boxes, the heading will show and content will say *none*.

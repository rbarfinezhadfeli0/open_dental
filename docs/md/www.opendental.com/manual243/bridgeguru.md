...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **Guru**.

![](images/bridgeGuru.png)

Guru is a case acceptance platform. Website: <https://www.gurudental.com/>.

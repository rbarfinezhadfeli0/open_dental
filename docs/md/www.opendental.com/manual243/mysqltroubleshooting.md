...
* If a non-standard installation was performed and MySQL was installed separately, then it might be a security issue such as improper use of MySQL user name and password. See [MySQL Security](securitymysql.html).

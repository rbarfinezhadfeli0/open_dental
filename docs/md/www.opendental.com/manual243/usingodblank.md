...
Before entering patient data, it is important to set time aside to address [HIPAA](../site/hipaa.html) issues and set up Open Dental for your practice.

Resources

* [Setup Wizard](setupwizard.html): A quick way to enter basic setup information.
* [Setup Checklist.pdf](../resources/Setup%20Checklist.pdf): A checklist of recommended setup items.
* [Webinars and Videos](https://www.youtube.com/channel/UC2f1mkxYSud-V72gxpgmRrQ)
...
* Create a new patient or family from [Select Patient](patientselect.html).
* Enter [Patient Information](patientedit.html).
* In the [Family Module](family.html):
...
* If treatment is needed, enter [Planned Appointments](apptplanned.html) for the next appointment (treatment that is priority #1). This information will by used by the front desk to schedule the next appointment.
...
* Insurance payments: Receive and enter insurance payments.

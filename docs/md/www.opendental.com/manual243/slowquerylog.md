...
* **Grade**: An evaluation of how bad the slow query log is. It is based off the average of small to medium sized offices.
  + If the grade is A or B, the slowness is likely not related to the queries. Check the worst queries regardless.
  + If the grade is C, the slowness may be related to the queries. Check the worst queries or escalate if unsure.
  + If the grade is D or F, the slowness is likely related to the queries. Check the worst queries, third party queries, and the tests below.

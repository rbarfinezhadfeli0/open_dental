...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **DentalEye**.

![](images/bridgeDentalEye.png)

DentalEye is an imaging software. This bridge can also be used for [MiPACS Bridge](bridgemipacs.html). Website: <http://www.dentaleye.com/>.

Note: Users must have DentalEye version 3.3 or greater installed.

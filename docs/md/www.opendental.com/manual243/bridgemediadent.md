...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **MediaDent from www.mediadentusa.com**.

![](images/bridgeMediaDent.png)

MediaDent is an imaging software. Website: <http://www.mediadentusa.com/>. [CADI Bridge](bridgecadi.html) is a re-branded version of MediaDent.
...
3. Double-click on a row in **Additional Properties** to change settings.
   ...
   2. Verify **Text file path**. Only used with version 5.
   3. Enter **MediaDent version either 4 or 5**.
   4. Verify **Image Folder** path. Only used with version 4.

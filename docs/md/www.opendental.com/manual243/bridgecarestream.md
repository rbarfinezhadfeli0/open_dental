...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **Carestream Ortho/OMS from www.carestreamdental.com**.

![](images/bridgeCarestream.png)

Carestream is a digital imaging software. <https://www.carestream.com/en/us>.

This bridge is only for Carestream Ortho/OMS. For the standard Carestream bridge, use [Trophy (Enhanced) Bridge](bridgetrophyenhanced.html).
...
3. Double-click on a row in **Additional Properties** to change settings.
   ...
   2. Verify the **Patient.ini path**. If changed, the value cannot exceed 150 characters.

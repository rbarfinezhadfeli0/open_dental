...
* **Fee Schedule**: The [Fee Schedule](feeschedules.html) assigned to the Discount Plan.
* **Adjustment Type**: The [Adjustment Type](definitionsadjtypes.html) assigned to the Discount Plan.
* **Pats**: Number of patients currently using this Discount Plan.
...
* **Add**: Create a new Discount Plan. Opens Discount Plan Edit (see below).
* **Merge**: Combine two Discount Plans. See: [Merge Discount Plans](mergediscountplans.html)

## Preparing to Create a Discount Plan

1. Create the [Definitions: Adj Types](definitionsadjtypes.html) to be used for the Discount Plan's adjustments. Create one adjustment for all Discount Plans or create an adjustment for each individual Discount Plan for tracking purposes and reports.
...
* **Discount Plan ID**: Read-only. A system-generated number assigned to each Discount Plan automatically.
* **Description**: The name of the Discount Plan.
* **Fee Schedule**: Click **[...]** to associate a fee schedule with the plan. This affects calculated discounts and adjustments.
* **Adjustment Type**: Use the dropdown to associate an Adjustment Type with the plan. This is used to generate the discount on completed procedures.
* **Patients**: The count of patients assigned to the Discount Plan. Click the dropdown to see a list of patients.
...
Run the [Daily Adjustments Report](reportdailyadj.html) to find discount plan adjustments that were created in a timespan.
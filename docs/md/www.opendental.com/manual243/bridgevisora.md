...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **visOra**.

![](images/bridgeVisOra.png)

visOra is a digital imaging software.

...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **HDX WILL from www.hdx.co.kr**.

![](images/bridgeHDXW.png)

HDX Will is an imaging software. Website: [hdxwillna.com](http://hdxwillna.com/).
...
3. Double-click on **Additional Properties** to change settings.
   ...
   2. Verify the **System path to HDX WILL Argument ini** file is correct.

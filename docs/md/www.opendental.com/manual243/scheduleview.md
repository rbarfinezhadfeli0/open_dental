...
In the [Time Clock](timeclock.html) area, select the employee(s). Click **View Schedule.**

![](images/scheduleView.png)

The view is read-only except for users with the *Schedules - Practice and Provider*[Security Permission](permissions.html). Users with the security permission access a view that allows them to edit schedules. See [Schedule Setup](schedule.html) for more information.
...
* **Show Clinic Holidays and Notes**: Only an option when the Clinics feature is enabled in [Show Features](showfeatures.html). Show the selected clinic's holidays and notes entered.
...
Click **Print** to send a copy of the displayed schedule to the printer.
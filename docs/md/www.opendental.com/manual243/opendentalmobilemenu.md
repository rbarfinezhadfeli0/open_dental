...
In [ODMobile](opendentalmobile.html), tap **More Options**.

![](images/mobileMenu.png)

## Reports

See [ODMobile Reports](opendentalmobilereports.html) for report options and instructions.

## Patient Images

View patient images from the Imaging Module. First tap, then search by patient name.

![](images/mobileImages.png)

Only [Image Categories](definitionsimagecat.html), not marked *Hidden*, with images for the selected patient are listed. Tap an image description to view it.

## Pharmacies

View [Pharmacies](pharmacies.html) entered in Open Dental.

![](images/mobilePharmacies.png)
...
![](images/mobilePharmaciesView.png)

Tap the pin icon to view the pharmacy location in Google Maps.

## eRx

Tap to view [DoseSpot eRx / Prescription](dosespotuse.html).

## Settings

See [ODMobile Settings](opendentalmobilesettings.html) for details.

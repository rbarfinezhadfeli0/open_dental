...
Setup Ortho Hardware Specs

This sets up a list of hardware for users to pick from later.

In [Preferences](preferences.html), next to Ortho Hardware Specs, click **Setup**.

![](images/orthoHardwareSpecsSetup.png)
...
When adding or editing an Ortho Hardware Spec, the Edit Ortho Hardware Spec window will open.

![](images/orthoHardwareAdd.png)

**Type**: This field is read-only. Indicates the kind of ortho hardware. If this is a new ortho hardware and the incorrect type was chosen, click **Cancel** and choose the correct Type from the Setup window before clicking Add.

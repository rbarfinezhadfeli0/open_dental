...
**Billing Types:** Check **All** to include all [Billing Types](definitionsbillingtypes.html) or uncheck the box to select specific types.
...
Click **OK** to generate a print preview the report. The following is an example of the report and explanation of the report columns. For a description of toolbar buttons, see [Complex Report System](reportcomplex.html).

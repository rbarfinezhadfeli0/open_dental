...
In the [Main Menu](mainmenu.html), click [Reports](reports.html), Graphic.

![](images/reportsGraphicOverview.gif)

The reports that display are customized by the practice in [Graphic Reports Setup](reportsgraphicsetup.html). Each report can show results for the entire practice, by provider or clinic, and for a specific date range.
...
* Hover over a report to display three clickable icons:
  ...
  ![](images/reportsGraphicRefresh.gif)Refresh the data in the report.

  ![](images/reportsGraphicPrintExport.gif)Print or export the report data.

  ![](images/reportsGraphicEdit.gif)Temporarily edit report criteria. These changes will immediately affect the report view, but will not be saved.
...
![](images/reportsGraphicPrintSettings.gif)

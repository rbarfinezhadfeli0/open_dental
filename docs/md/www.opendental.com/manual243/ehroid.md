...
Object identifiers are global unique identifiers used when sending or exporting [Continuity of Care Document (CCD)](ehrccd.html), medical lab orders, or [EHR Clinical Quality Measures](ehrcqm.html). It uniquely identifies a patient in the database. OIDs are made up of the Root + Type identifier.

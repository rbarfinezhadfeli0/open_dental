...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **HandyDentist**.

![](images/bridgeHandyDentist.png)

HandyDentist is an imaging software.

To enabled the bridge:
...
The bridge uses PatNum, FName and LName.
...
**Edit**: Select an account, then click to make edits to the name, type, inactive status, and color. See Edit Account below.

**Export**: Save the Chart of Accounts grid as a text or Excel file. Change the *As of Date* to export the Balance totals for the date entered.

...
Midway Dental Bridge

In the [Main Menu](mainmenu.html) click Setup, [Program Links](programlinks.html). Double-click on **Midway Dental**.

![](images/bridgeMidwayDental.png)

Midway Dental is a dental supply company. Website: <http://www.midwaydental.com/>.

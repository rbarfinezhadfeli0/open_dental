...
* **Show PatNums**: Show patient numbers next to guarantors name. Defaults to the setting in [Report Setup: Misc Settings](reportmiscsettings.html) for *Show PatNum*.

...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **SteriSimple from www.sterisimple.ca**.

![](images/bridgeSteriSimple.png)

SteriSimple is a reprocessing solution. Website: <https://sterisimple.ca/>.

...
* To set up a plan that has copays and makes supplemental payments (mixed capitation), see [HMOs/DMOswith Supplemental Payments and Copays](planhmosupplemental.html) instead.

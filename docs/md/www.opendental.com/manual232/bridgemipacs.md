...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **MiPACS Imaging**.

![](images/bridgeMipacs.png)

MiPACS is a digital dental imaging system. Website: [www.medicorimaging.com](http://www.medicorimaging.com/).

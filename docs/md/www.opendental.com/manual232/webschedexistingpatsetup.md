...
Web Sched Existing Pat Appt Types must be created prior to offering Web Sched Existing Patient. Web Sched Existing Patient Appointment Types determine the reasons patients can select for their appointment, the procedures for the appointment, the appointment length, and the time pattern.

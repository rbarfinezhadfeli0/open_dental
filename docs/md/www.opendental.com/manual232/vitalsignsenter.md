...
* **Height**: Patient's height in inches. Height Code is automatically selected when height is entered; you can select another option if desired. Required when sending prescriptions through NewCrop eRX.
* **Weight**: Patient's weight in pounds (lbs). Weight Code is automatically selected when weight is entered; you can select another option if desired. Required when sending prescriptions through NewCrop eRX.

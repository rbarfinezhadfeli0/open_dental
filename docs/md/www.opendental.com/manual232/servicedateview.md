...
In the [Account Module](account.html), Main tab, click Service Date View.

![](images/serviceDateView.png)

Each charge on the account is listed, followed by every attached credit.

...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **DentForms from medictalk.com**.

![](images/bridgeDentForms.png)

DentForms is an electronic forms software. Website: <http://www.medictalk.com>

...
In the [NewCrop eRx / Prescription](newcrop.html) interface, click the **Tasks** tab. At the bottom is a Failed Prescriptions list.
...
1. In the NewCrop eRx window, Compose Rx tab, click the Edit dropdown.
2. Click **Detail**.
3. Scroll to the bottom. In the *Prescription History* section, any Failure will be noted in the status column.

...
Here is how Sales Tax appears in the [Account Module](account.html):

![](images/salesTaxExample.gif)
...
* If the sales tax provider is different than the procedures' provider, the sales tax adjustment will show as a separate charge in the [Payment](payment.html) window, Outstanding Charges grid, even though the adjustment is attached to the procedure.
...
![](images/toolbarSalesTax.gif)

A sales tax adjustment will be immediately created and attached to each procedure. The adjustment is directly attached to the procedure.

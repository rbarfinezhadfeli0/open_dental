...
Select the reporting date range in the calendars. In the left calendar, select the dart date. In the right calendar, select the end date.
...
* **Birthdate**: Patient's age set in Public Health Screeningg.
...
* **ExistingSealants**: When using Public Health Screening Classic, response to  *Needs Selants*. Not used for Public Health Custom Screening.

...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **Easy Notes Pro**.

![](images/bridgeEasyNotes.png)

To enable the bridge:

1. Check the **Enabled** box.
2. Verify the **Path of file to open**.
3. Verify the **Optional command line arguments**. Typically this does not need to change.

...
Update Open Dental to the latest stable version.

## eClipboard Errors

**Validation Failed**

Each tablet needs to be enabled in Open Dental before it can be used for eClipboard. In [eClipboard Setup](eclipboardsetup.html), check the *Enabled* box next to the device.

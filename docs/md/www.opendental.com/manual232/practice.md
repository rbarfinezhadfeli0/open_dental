...
Enter the general contact and billing information for the practice. Practices using clinics should enter each clinic's contact and billing information under in the [Clinic List](clinicsetup.html).

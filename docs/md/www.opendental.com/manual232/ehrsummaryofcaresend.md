...
Summaries of care, also known as transition of care summaries, are [EHR Continuity of Care Document ( CCD )](ehrccd.html) that are sent to another provider when a patient is referred or transitioned. These documents are part of the [EHR Health Information Exchange](../site/ehrhealthinfoexchange.html) objective in EHR Modified Stage 2.

...
* In [Show Features](showfeatures.html), check the radio button to enable the Late Charge feature. Once enabled, Late Charges will be available in the Tools menu.
...
Note: Charges will only be made for super families whose sum of positive family balances are greater than or equal to this amount.

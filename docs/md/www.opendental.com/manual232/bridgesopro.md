...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **Sopro by Acteon www.acteongroup.com**.

![](images/bridgeSopro.png)

Sopro by Acteon is imaging software. Website: [www.acteongroup.com](http://www.acteongroup.com).
...
You may need to configure Sopro to accept bridge arguments. Sopro Image Menu File, Setup, Main tab, Link section, select Type 90 and check the box for *Always Update The Files*.
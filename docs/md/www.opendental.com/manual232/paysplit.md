...
**Clinic**: The clinic to allocate the income from this paysplit to. Defaults to the clinic assigned to the payment. Set the default clinic in Preferences, *Patient payments use*.
...
* **Ins Est**: Outstanding insurance estimated of created claims.

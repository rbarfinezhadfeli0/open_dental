...
* Images sizes should not exceed the size of the sheet minus the margins (e.g., 850 x1000). White space (for example, the bottom of a scanned image) should be cropped out. Smaller file sizes are less likely to have any loading issues.

...
In [ODMobile](opendentalmobile.html), tap the **Appts** tab.

![](images/mobileAppts.png)

The Appointments Tab opens by default when the app is opened. It displays the [Appointments Module](appointments.html).

## Appointments Tab

Operatories associated with the [Appointment View](appointmentviews.html) display.

* Customize views for ODMobile in the [Appointment View Edit](appointmentvieweditwindow.html) window.
* On phone devices, one operatory displays at a time. On tablet devices, multiple operatories display.
...
![](images/mobileApptsPinboardDisplay.png)
...
Fields available when scheduling or editing an appointment via ODMobile align with the fields on the [Edit Appointment](aptedit.html) window.

To add procedures to an appointment, use [Appointment Types](appointmenttypes.html).
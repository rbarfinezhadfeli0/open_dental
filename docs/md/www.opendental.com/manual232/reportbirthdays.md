...
* To edit the number of post cards that print on each sheet, see [Setup Recall](recallsetup.html).
...
![](images/reportBirthdayPostcard.gif)
...
![](images/reportBirthdayPrint.gif)

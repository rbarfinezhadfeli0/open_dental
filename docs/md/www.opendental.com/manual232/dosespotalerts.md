...
Providers, non-doctors, and clinics subscribed to [DoseSpot](dosespotuse.html) receive eRx alerts

In the [Main Menu](mainmenu.html), click [Alerts](alerts.html).

![](images/dosespotAlertAssignID.PNG)

Before alerts display, each provider/proxy clinician and clinic must be subscribed to *eRx Alerts*. See [Alert Subscription](alertsubscribe.html).
...
1. Click the alert, then click *Open*.
   ![](images/dosespotAlertAssignIdWindow.PNG)
2. Assign a user.

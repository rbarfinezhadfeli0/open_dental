...
* **OT**: Hours entered for a time card adjusmtent with *Overtime Adjustment* checked.
...
A user with the *Edit All Time Cards* permission, who is not the same person as the employee whose Time Card needs to be edited, will need to edit the clock event.

...
3. Enter the amount of the original transaction as a negative (e.g., -50).
...
4. Click **OK** to open the [Payment](payment.html) window.
   ...
   * **Current Payment Splits**: Allocate the voids payment split ([Paysplit](paysplit.html)) to the production or unearned type of the original payment. See [Paysplit Revise](paysplitsedit.html).

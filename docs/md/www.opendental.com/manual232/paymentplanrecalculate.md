...
In a [Payment Plan](paymentplanpatient.html), under Terms, click **Recalculate**.

![](images/paymentplanRecalculate.gif)

Note: Added adjustments will not be recalculated. Manually edit any payment plan adjustments in the patient account, amortization schedule, and in the Payment Plan Procedures and Credits window.

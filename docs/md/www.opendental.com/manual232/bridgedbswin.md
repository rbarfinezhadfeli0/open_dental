...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **DBSWin**.

![](images/bridgeDBSWin.png)
...
If DBSWin is not switching patients as expected, patients may need to have their Date of Birth entered in [Edit Patient Information](patientedit.html).
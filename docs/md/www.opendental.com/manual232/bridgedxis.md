...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **DXIS**.

![](images/bridgedxis.png)

DXIS is an imaging system that is no longer sold.

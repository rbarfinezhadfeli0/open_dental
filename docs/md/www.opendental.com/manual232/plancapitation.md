...
5. Click **OK**, then send the claim. If the office do not expect to apply a payment for the claim, then mark the claim as received so it does not show on the Outstanding Insurance Claims report.

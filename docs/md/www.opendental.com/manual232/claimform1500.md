...
| 6 | Patient's Relationship to Insured | [Insurance Plan](insplan.html) window, Relationship to Patient or [Claim](claimedit.html), Relationship |
...
| 21 A-L | Diagnosis of Nature of Illness | [Procedure - Medical Tab](proceduremedical.html), ICD codes. The first 12 unique diagnoses codes in the claim will show. ICD Ind will show 9 if using ICD-9 codes or 0 if using ICD-10 codes. |
...
| 24H |  |  |
| 24I | ID Qual |  |
| 24J | Rendering Provider ID | NPI Number of treating [Provider](providerseditwindow.html) |

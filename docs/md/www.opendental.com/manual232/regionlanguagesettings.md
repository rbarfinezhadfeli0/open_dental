...
![](images/regionLanguageSettings.png)
...
* [Language Translations](languages.html) are only available when the Region and Language setting is set to a foreign language.
* [Canada](canada.html) users must have their setting set to English (Canada) to view Canadian features.
* Currency symbols and date format are affected by Region and Language.
* Region and Language on the workstations should match the setting *Language and region used by program* found in [Miscellaneous Setup](miscsetup.html).
...
Solution: Turn on composition typing in [Miscellaneous Setup](miscsetup.html).

**Problem: I receive this message when I start Open Dental.**

![](images/languageSettingsMismatched.gif)

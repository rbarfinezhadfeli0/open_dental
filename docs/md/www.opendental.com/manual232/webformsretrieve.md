...
**Batch Size**: Enter a batch size between 1 and 255. The default is 10. All forms are downloaded at once, however they are downloaded in batches in the background. Smaller batches help large volume practices from timing out.

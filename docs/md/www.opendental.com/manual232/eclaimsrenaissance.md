...
Renaissance is an e-claims clearinghouse solution that uses the Remote Lite software. Visit [www.vynedental.com](https://vynedental.com/) to learn more about their services.
 Other names for Renaissance include Vyne Dental & Dental Hero.

New Vyne Dental users should enable the [Vyne Dental E-Claims](eclaimsvyne.html) clearinghouse instead.

Vyne Dental is moving all existing Renaissance users to Vyne Dental. If claims stop sending, contact Open Dental Support for assistance moving to Vyne Dental. An Open Dental update may be required.

## Open Dental Setup

Contact Renaissance to set up an account and install the RemoteLite program.

Set up using above screenshot as a reference, then click OK to save.

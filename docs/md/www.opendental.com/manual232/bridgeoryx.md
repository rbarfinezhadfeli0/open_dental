...
In [Program Links](programlinks.html), double-click on **Oryx from oryxdentalsoftware.com**.

![](images/bridgeOryx.png)
...
3. Set up up a clickable bridge button.

...
In the [Claim](claimedit.html) Edit window, at the upper-right, is a **Supplemental** button.
...
Supplemental payments can also be created using the **To Supplemental** button. See Pending Payment section in [Claim](claimedit.html).

## Receiving a Supplemental Payment

To receive a supplemental payment, follow the steps below:

1. Highlight the procedure line items the supplemental payment applies to.
...
6. Enter the amount and verify the attached claim(s). See [Finalize Insurance Payment](claimpayfinalize.html).

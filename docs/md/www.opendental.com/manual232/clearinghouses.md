...
Determine the default clearinghouse for Dental, Medical, and Eligibility.
...
* [Change Healthcare E-Claims](eclaimswebmd.html) - Formerly Emdeon, WebMD, Envoy.
...
* [ITRANS 2.0](itrans20.html) - Dentists only.
* [Claimstream](claimstream.html) (TELUS / CCDWS) - Hygienists only.
...
For troubleshooting, see [Clearinghouse Error Messages](eclaimserrors.html).

For more technical information about what is sent in e-claims, see [E-Claim Complexities](eclaimscomplexities.html).

Some clearinghouses not listed above are not recommended. See [Third-Party Warnings](../manual/thirdpartywarnings.html) for more information.
...
Ortho Insight 3D Bridge

In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **Ortho Insight 3d from http://www.motionview3d.com.**

![](images/bridgeOrthoInsight3D.png)

Ortho Insight 3D is an imaging software. Website: [http://motionview3d.com](http://motionview3d.com/index.php)

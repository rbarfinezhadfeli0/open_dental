...
**Problem: There are no available time slots for patients to choose from.Solution:Check all setup options to make sure information is complete and accurate.**

...
Claim forms can be customized or added as needed. Changes to claim forms only affect printed claims and do not affect electronic claims. We recommend contacting Open Dental support if you need to make changes, as changes may affect claim submission and payment.
...
The left side of the window will show the items on the claim form. The right side of the window will have an edit panel.
...
**Offset X** / **Offset Y**: Change the alignment of the form when printing on a preprinted form. Values can be positive or negative and will shift all elements on the page by the given number of pixels in hundredths of an inch.
...
5. Click **Add** to add fields. When a field is added, move it to it's appropriate location on the claim form.- Move items by clicking and dragging or by using the arrow keys.

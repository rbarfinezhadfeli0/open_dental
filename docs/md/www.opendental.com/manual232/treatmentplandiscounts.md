...
In the [Treatment Plan Module](treatmentplan.html), click **Discount**.

![](images/tpDiscount.gif)

* To apply a percentage discount to specific procedures, highlight the procedures first, then click Discount.
* To apply a percentage discount to all procedures, do not select any procedures, then click Discount.
...
* Set the *Default Procedure discount percentage* and *Procedure discount adj type* in [Preferences](preferences.html).
...
Enter the amount in the [Procedure - Financial Tab](procedurefinancial.html).

![](images/tpDiscountProcedure.gif)
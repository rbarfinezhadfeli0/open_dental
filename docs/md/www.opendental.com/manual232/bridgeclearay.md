...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **CleaRay**.

![](images/bridgeCleaRay.png)

CleaRay is a USB intraoral x-ray imaging software.

...
**Clinics**: Select clinic to inlcude in the report. Ctrl + click to select multiple. Check **All (Includes hidden)** to select all clinics, including those that are hidden, and include patients not assigned to a clinic.

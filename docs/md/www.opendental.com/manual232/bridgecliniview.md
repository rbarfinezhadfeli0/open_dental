...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **CliniView**.

![](images/bridgeCliniview.png)

CliniView is an imaging software. Website: <https://www.kavo.com/en-us/?lang=en-us>.
...
Note: If the CliniView bridge does not launch, use the [Apteryx Bridge](bridgeapteryx.html) instead.
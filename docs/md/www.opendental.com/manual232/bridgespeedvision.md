...
Lightyear SpeedVision is no longer sold.

In the [Main Menu](mainmenu.html), click Setup, [Program-Links](programlinks.html). Double-click on **SpeedVision from www.lightyeardirect.com**.

![](images/bridgeSpeedvision.png)

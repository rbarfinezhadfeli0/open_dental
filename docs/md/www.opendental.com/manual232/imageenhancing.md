...
A raw image, such as a radiograph, may need to be adjusted to make it easier to see a specific feature such as caries or an abscess. You cannot do this with a film radiograph, and this is a major advantage of using digital radiographs.

...
![](images/bridgeCustom.gif)

Adding a custom bridge is useful if a user knows how to write a [Program Link Output File](programlinkoutputfile.html). Only add custom bridges for bridges we do not already support.

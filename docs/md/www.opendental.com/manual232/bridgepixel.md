...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **Pixel by Digital Doc**.

![](images/bridgePixel.png)

Pixel is a dental imaging application. Website: <https://digi-doc.com/>.

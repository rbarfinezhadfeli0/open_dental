...
* Install [CDA Digital IDs](cdadigitalcert.html).
* Install ITRANS Claims Director service (see below).
* Setup the ITRANS 2.0 clearinghouse in Open Dental (see below).

Note:

* ITRANS 2.0 is for dentist providers. If the user is an Independent Hygienist, see [CCDWS Service](ccdws.html) for claim submission.
...
9. Enter the Service User Account and password. This is the user that CDA Digital IDs (i.e., provider certificates) were installed to. Then click **Next**.

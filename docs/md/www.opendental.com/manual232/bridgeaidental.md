...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **Ai-Dental**.

![](images/bridgeAiDental.png)

Ai-Dental is a dental imaging software.

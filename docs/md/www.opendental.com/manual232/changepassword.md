...
To create an initial temporary password, go to [User Edit](securityusers.html) for the new user, then click Create Password. To require a password reset when the user first logs on, check *Require Password Reset* in the user settings.
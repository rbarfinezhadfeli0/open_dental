...
In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html). Double-click on **Z-Image**.

![](images/bridgeZImage.png)

Z-Image is digital imaging software. Website: [www.cieos.com](http://www.cieos.com).
...
Uses command line arguments for Pat ID, LName, FName, DOB, SSN, and Gender.
...
| **Comcast** | xxxx@comcast.net | checked | smtp.comcast.net | 587 |  |  |
...
| **Roundcube** | xxx@domainname.com | checked | mail.domainname.com | 587 |  |  |
...
**Email message cannot contain the URL [URL] as this is only allowed for eServices.**
...
Solution: AOL may be requiring an app password that can be created in AOL Account Security.
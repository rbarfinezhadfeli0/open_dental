...
**Edit**: Only displays when Clinics is enabled. Click to enter clinic-level overrides for license information.
...
**Signature on File**: Indicate whether or not the provider has a signature on file. May affect what shows on the [ADA 2012 and 2018 Claim Forms](claimformada2012.html) for treating provider signature.

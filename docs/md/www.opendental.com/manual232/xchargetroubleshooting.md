...
**Problem: After the [XCharge (OpenEdge)](xcharge.html) window is closed, the wrong information goes into the Payment window in Open Dental. For example patient A paid $200 using XCharge and when going to patient B account to make a $150 patient payment it shows patient A's $200 payment.**

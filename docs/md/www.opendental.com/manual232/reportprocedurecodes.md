...
![](images/reportProcedureCodes.gif)
...
Note: The Provider and Clinic options reflect the [Provider or Clinic Fee Overrides](procedurefeeoverrides.html) in the [Procedure Codes](procedurecodes.html) List. Choosing both a provider and clinic will show only fee overrides for that provider and clinic combination.
...
* **Code**: Sort the report by procedure code. Codes in hidden categories will be included.
* **Categories**: Group the report by procedure code category. Codes in hidden categories will not be included.
...
![](images/reportProcedureCodePrintGlobal.gif)

**Example 2**: Clinic fee overrides by Code

![](images/reportProcedureCodePrintClinic.gif)

**Example 3:** Clinic and Provider fee overrides by Code

![](images/reportProcedureCodePrintClinicProv.gif)

Report Columns* **Category**: Procedure code category. Only appears when report is sorted by *Category*. The category name will appear once for each category grouping.
* **Code**: Procedure code.

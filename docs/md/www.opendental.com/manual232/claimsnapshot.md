...
* [Daily Writeoff Report](reportdailywriteoffs.html) - When utilizing *Using initial claim date for write-off estimates, insurance pay date for write-off adjustments* setting for insurance write-offs.

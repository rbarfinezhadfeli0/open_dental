...
Log into the server, then download and save [SigPlus.exe](http://www.topazsystems.com/Software/sigplus.exe).
...
1. Download and save the [SigPlus BSB Pad Installer (.exe)](http://www.topazsystems.com/software/sigplusbsb.exe) to your local client computer/terminal.

...
![](images/timeAskArrivePrompt.gif)

When *Ask To Arrive Early* value has already been entered in [Edit Patient Information](patientedit.html), this message appears immediately upon creating or selecting a patient's scheduled appointment. The *Time Ask To Arrive* is automatically prefilled on new appointments for the patient.

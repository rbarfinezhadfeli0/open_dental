...
In the [Main Menu](mainmenu.html) click Setup, [Program Links](programlinks.html). Double-click on **Vipersoft aka Clarity**.

![](images/bridgeVipersoft.png)

Vipersoft is no longer sold. It was renamed as Dentrix Clarity.
...
The bridge sends the patient last name, first name, middle name, provider first and last name, and SSN.
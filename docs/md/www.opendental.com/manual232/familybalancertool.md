...
* [Insurance Overpaid Report](reportinsoverpaid.html)
  + Insurance overpayments are ignored by the Family Balancer Tool. The tool still runs on the family, which may result in unexpected mismatches between individual family members' account balances.
* [Payment Plans Report](reportpaymentplan.html)
  ...
  + For [Patient Payment Plans](paymentplanpatient.html), from the patient [Account Module](account.html):

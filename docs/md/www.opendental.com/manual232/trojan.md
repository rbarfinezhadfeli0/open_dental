...
The benefit information is stored on a computer in the dental office, and gets frequently updated through the internet. Instead of a direct integration with their database, we have chosen a simpler integration, using an intermediate standalone Trojan program. Website: [www.trojanonline.com](http://www.trojanonline.com/).

...
* Each checkbox indicates whether the eService is currently active, pending stop, or inactive. Click in a box to change its status.
  ...
  + Totals: As eServices are selected, the total $ amounts will update to reflect new charges.
* Yellow highlight: eClipboard and Mobile will highlight in yellow if [Mobile Settings](mobilesettings.html) for the clinic are incomplete.

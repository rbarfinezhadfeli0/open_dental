...
In the [Payment](payment.html) window, right-click [XCharge](xcharge.html), click **Settings**.
...
* In the [Main Menu](mainmenu.html), click Setup, [Program Links](programlinks.html), and double-click X-Charge from x-charge.com.

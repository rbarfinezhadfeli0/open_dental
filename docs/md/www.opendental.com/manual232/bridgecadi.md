...
In the [Main Menu](mainmenu.html) click Setup, [Program Links](programlinks.html). Double-click on **CADI from www.cadi.net**.

![](images/bridgecadi.png)

CADI is an imaging software. It is a re-branded version of [MediaDent Bridge](bridgemediadent.html). Website: <http://www.cadi.net>
...
CADI version 6.10.x is MediaDent version 4.
...
File [Replication](replication.html) for shared network folders is important so you can keep folders and files in sync across [Multiple Locations](multiplelocations.html). Below are some file replication tools. See also: [Store Images in Database](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7imagesstoreindb.html).

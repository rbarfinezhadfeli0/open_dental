...
3. Install the [Open Dental Replication Service](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7opendentalreplicationservice.html) on each Replica.
...
8. Install the [Open Dental Replication Service](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7opendentalreplicationservice.html) on the new server(s). The service will notify all users and IT staff if replication crashes via Alerts.
...
* **OpenDentImages** ([A to Z Folder](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7atozfolder.html)): This folder stores files that you capture, scan, or import.
...
**Data that is transported across a network**: There are optional features that involve sending patient data to, or from, your Open Dental database.
...
| DoseSpot eRx | Yes | HTTPS over SSL | Uses JWT-based authentication. |
| Ensora eRx | Yes | HTTPS over SSL |  |
...
| Supplemental Backups | Yes | EncryptionAlgorithm.WinZipAes256 | See details on [Supplemental Backups](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7supplementalbackups.html). |

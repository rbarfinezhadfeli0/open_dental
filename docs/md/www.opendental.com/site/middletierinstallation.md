...
* Make sure all Open Dental Users that will be connecting through Middle Tier have a [Password](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7changepassword.html) created.
* In the production database, change the *Update Server* in [Preferences](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7preferences.html) to match the Middle Tier server name.
...
**To disable** (requires the *Choose Database*, [Permissions](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7permissions.html)):

1. Launch Open Dental.
2. In the [Main Menu](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7mainmenu.html) select File, Choose Database to open the Choose Database window.

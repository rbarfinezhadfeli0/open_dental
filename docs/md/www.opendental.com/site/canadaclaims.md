...
For [Canada](canada.html) users, in the [Account Module](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7account.html), click **New Claim**, or double-click an existing claim to edit.
...
Buttons and fields in this window match what is found in the Edit [Claim](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7claimedit.html) window for the U.S. version. Differences are noted below.
...
**Treatment Required for Ortho**: Only used for [Ortho](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7orthodontic.html) claims. If checked, the ortho flag is sent.
...
**Missing Teeth**: List of the patient's missing teeth. For display only. Change the missing status of teeth from the Chart Module, [Missing/Primary Teeth](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7missingteeth.html) tab.
...
To add a note to a claim, use the Remarks field in the [Edit Claim - General Tab](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7claimtabgeneral.html) for printed claims, or add a text file as an attachment for electronic claims.
...
If insurance is requiring the student school and status, enter information in the [Edit Patient Information](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7patientedit.html) window under Name of School and Eligibility Excep. Code.

...
For [Canada](canada.html) users, in the [Manage Module](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7manage.html), click Send Claims.
...
For a full description of all buttons and columns, see [Send Claims](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7claimsend.html). Below is detail on features specific to Canada.

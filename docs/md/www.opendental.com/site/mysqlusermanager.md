...
Note: The [Open Dental Service](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7opendentalservice.html) and [eConnector](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7econnector.html) must be reinstalled after using the MySQL User Manager to create or change a password for the user they are set up with. This is normally the 'root' user.
...
12. Launch Open Dental on Primary Server using *LocalHost* and the replicated database. Enter information in *Read-Only Server Setup* in [Preferences](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7preferences.html) or [Report Setup: Report Server](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7reportserver.html).
13. Ensure replication is working as intended by performing the following:
    1. On the Primary Server, create an appointment for a test patient and make note of the patient's Patient Number. See [Edit Patient Information](../autoLogin.aspx%EF%B9%96ReturnUrl%3D%EA%A4%B7help253%EA%A4%B7patientedit.html)

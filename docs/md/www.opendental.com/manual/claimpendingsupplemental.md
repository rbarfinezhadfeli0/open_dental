...
In the Edit [Claim](claimedit.html) window, at the upper-right, is a Pending Payments section.
...
**To Supplemental**: Change all Pending Supplemental (*PndSup*) payments to Supplemental (*Supp*). [Finalize Insurance Payment](claimpayfinalize.html) after using this option.

...
* Add the *Guardians* row to an [Appointment View](appointmentviews.html) to show this relationship on appointments.
* Add the Guardians field to Fields Showing in [Display Fields](displayfields.html), PatientInformation to show the relationship in the the Family Module, Patient Information area (first name, relationship abbreviation).

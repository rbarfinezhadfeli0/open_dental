...
Note: If there is a procedure copay, Covered Amount = PPO Fee - (Deductible + Copay)
...
Note: If there is a procedure copay, Covered Amount = Substitution Code PPO Fee - (Deductible + Copay)

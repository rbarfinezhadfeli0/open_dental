...
![](images/paymentPortalMsgtoPayTemplate.png)

**Text Message**: Customize the default text message template.

**Email Subject and Body**: Customize the default email message template. Click **Edit** to open [HTML Email](emailhtml.html) for additional customization.

...
Send Postcards (Advertising)

Use this window to design postcards and send them.

In [Upload Postcard Recipients](postcardsupload.html), click **Upload List**.

![](images/postcardAdvertisingDesign.png)

Alternatively,

* In the Upload Postcard Recipients window, click **Upload List**.
* In [Postcards Setup (Advertising)](postcardssetup.html), double-click an account. In the Advertising - Postcards Add Account window, click **View Account Details**.

For a step-by-step process for sending postcards, see [Postcards (Advertising): Workflow](postcardsadvertisingworkflow.html).

...
In the [Imaging Module](images.html), select an image. In the toolbar, click **Size/Rotation**.

![](images/imagesItemSize.png)
...
![](images/imagesMountSize.png)

These settings only affect the selected item on a [Mount](mountinfo.html).

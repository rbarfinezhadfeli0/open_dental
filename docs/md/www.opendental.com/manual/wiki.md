...
* **Setup**: Opens the Wiki Setup window. Customize the html master page and embedded stylesheet and choose wiki link settings.
  ![](images/wikiSetup.png)
  + **Detect wiki links in textboxes and grids**: Check to enable right-click options to open wiki links from textboxes and grids, (e.g., from [Tasks](tasks.html)). To create a wiki link in a task, use double brackets around the page title: [[Example Wiki Link]].
...
* **Edit**: Click to [Wiki Edit](wikiaddedit.html) to makes changes to the current page.
...
* **Add**: Click to create a new wiki page. Opens Wiki Edit.
* **Lists**: Click to view, create and edit [Wiki Lists](wikilists.html).
* **Search**: Click to open [Wiki Search](wikisearch.html) to find a different page.

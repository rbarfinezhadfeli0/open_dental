...
In the [Manage Module](manage.html), at the bottom, is the Messaging area.

![](images/messagingManage.gif)
...
* Use the [Tasks Area](tasksarea.html) for a more direct way of sending messages to specific staff members.
* Use [eServices Texting](textintegratedusage.html) for text messaging to patients.

## Buttons

Messaging buttons display on the left. For more information, see [Messaging Buttons](messagingbuttons.html).

![](images/messagingButtonArea.gif)

## Messaging Area

The messaging area determines the messages sent.

![](images/messagingArea.gif)

**To, From, Extras, Message (& Send)**: These columns list the [Message Elements](messagingelements.html). Several messaging elements come preset in Open Dental, but they can be customized or have new elements added.

To send a message:

1. Click on a **To**, **From**, and/or **Extra Item**. Each element is optional.
2. Click an item in **Message (& Send)** to immediately send it.
...
![](images/messagingAreaHistory.gif)
...
![](images/messagesAckDaysField.gif)

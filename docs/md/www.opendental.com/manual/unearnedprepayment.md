...
Note: An allocated prepayment may also be created when a Payment Plan charge is overpaid. See [Payment Plan](paymentplandynamic.html), Payment and Interest Logic for more information.

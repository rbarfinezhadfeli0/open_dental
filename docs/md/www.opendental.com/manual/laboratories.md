...
In the [Main Menu](mainmenu.html), click Setup, Laboratories.

![](images/laboratories.png)

The Laboratory list contains details about the laboratories an office sends [Lab Cases](labcaseedit.html) to.

Click **Add** to create a new lab or double-click on an existing lab to edit.
...
**Lab Slip:** Select the default lab slip sheet template to use for this lab. See [Lab Slip Layout](sheetslabslips.html) to customize a lab slip.
...
Click **Add**, or double-click a service to edit.

![](images/labTurnaround.gif)

Enter the turnaround information:

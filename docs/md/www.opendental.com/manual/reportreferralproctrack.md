...
In [Standard Reports](reportsstandard.html), in the Lists section, click **Referred Proc Tracking**.

![](images/reportReferredProcs.gif)

Also see [Referrals](referrals.html).
...
Double-click a row to open the [Edit Referral Attachment](referrals.html) window to view further details or edit the referral.

Below is an example of the printout and an explanation of the grid columns.

![](images/reportReferredProcsPrint.gif)
...
* **Description**: [Procedure Code](procedurecodeedit.html) description of referred procedure.

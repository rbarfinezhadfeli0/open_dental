...
* **Note**: The note that typically appears at the bottom of the treatment plan. Set the *Default Note* in Preferences. This text box supports [Right-Click Options](rightclicktextboxes.html).
...
3. Click **Save** to move the treatment to the *Unassigned* Inactive Treatment Plan.
...
4. Optional: Assign treatment to a treatment plan to access additional editing options.
   ...
   4. Click **Save** to create the new treatment plan.
...
Note: Most columns in the procedure grids are self-explanatory. The *Apt* column indicates if a procedure is attached to any appointment using the following abbreviations:

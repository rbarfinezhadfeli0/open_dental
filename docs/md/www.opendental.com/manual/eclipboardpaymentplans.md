...
In a [Payment Plan](paymentplandynamic.html), click **eClipboard**.

![](images/eClipboardPaymentPlan.png)

To save signed Payment Plans to the Imaging Module, enable *In eClipboard, save signed Payment Plans as PDF* in [Preferences](preferences.html).
...
![](images/eClipboardPaymentPlanChecklist.png)
...
2. The following window displays.
   ![](images/eClipboardPaymentPlanQR.png)
...
5. The Payment Plan populates in eClipboard.
   ![](images/eClipboardPaymentPlans.png)

## Signing the Payment Plan

Select the Payment Plan to sign.

![](images/eClipboardPaymentPlanShow.png)

Once the patient has made a decision, tap **Sign**.

![](images/eClipboardPaymentPlanSign.png)

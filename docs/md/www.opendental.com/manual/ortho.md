...
In the [Chart Module](chart.html), click the Ortho tab.

![](images/orthoChartModule.png)
...
Enable *Show Ortho button and tab in Chart Module* in [Preferences](preferences.html) to use this feature.

## Filters

![](images/orthoTabFilters.png)
...
Note: When the preference, *Automatically check and uncheck ortho mode and show grid checkboxes based on selection of Ortho tab*, is enabled, *Tooth Chart ortho mode* and  *Show Ortho grids* are automatically checked when opening the Ortho tab and unchecked upon exiting the Ortho tab.

**Show Graphics**: Determine if ortho graphics (e.g., brackets) are shown on the [Graphical Tooth Chart](graphicaltoothchart.html).
...
![](images/orthoTabHardware.png)

**Prescriptions**: Click to chart Ortho Hardware using [Ortho Prescriptions](orthoprescriptionssetup.html). Ortho Prescriptions are assigned to specific Ortho Hardware items and treatment areas. The Select Ortho Prescription window opens.

![](images/orthoPrescriptionAdd.png)
...
**Add Single**: Select teeth and click to add [Ortho Hardware](orthohardwaresetup.html). The Add Ortho Hardware window opens.

![](images/orthoAddHardware.png)
...
![](images/orthoTabHardwareTab.png)
...
![](images/orthoHardwareEdit.png)

Right-click selected rows to delete hardware.

## Ortho Chart Tabs

The tabs displayed after the Hardware tab show the [Ortho Chart](orthochart.html) tabs. Depending on [Ortho Chart Setup](orthochartsetup.html), *Setup Tabs*, the labels of the tabs and number of tabs may differ. The default is one tab labeled *Ortho Chart.*

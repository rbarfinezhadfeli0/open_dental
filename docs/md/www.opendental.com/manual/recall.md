...
* **Administrative Note**: Add notes about this patient's recall. Notes may also be added through the recall list. When the recall appointment is set complete, the note is removed. [Right-Click](rightclicktextboxes.html) the text box for additional options.

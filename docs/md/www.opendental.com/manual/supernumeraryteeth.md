...
2. On the [Procedure](procedureedit.html), change the tooth number.
...
Procedures for supernumerary teeth do not show on the graphical tooth chart, but they do get billed to insurance. To show a supernumerary tooth on the graphical tooth chart use the [Draw](chartdrawing.html) tool to draw in a tooth.
...
* Runs aging at *Automated aging run time* or *Aging Service Time Due*, scheduled in [Preferences](preferences.html).
...
* Adds charges for [Payment Plans](paymentplandynamic.html) based on *Pay Plan run time* scheduled in Preferences.
* Adds Automated [Repeating Charges](repeatingcharges.html).
* Runs various [CareCredit](../site/carecredit.html) processes.
* Automatically retrieves [Web Forms](../site/webforms.html).

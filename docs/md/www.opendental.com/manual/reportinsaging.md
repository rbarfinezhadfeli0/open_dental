...
* **Ins Est Total**: The total of any outstanding insurance estimates. This includes [Claim Procedures ( claimprocs )](claimprocedure.html) with a status of *Not Received* and [Pending Supplemental Insurance Overpayments/Underpayments](https://www.opendental.com/manual/claimpendingsupplemental).

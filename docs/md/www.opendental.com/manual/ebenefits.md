...
* **Response**: Click to view the raw response message sent by the clearinghouse. See below. ![](images/eBenefitRawMessage.png)
...
On the [Edit Insurance Plan](insplanedit.html) window, click **History**. All requests and responses are stored for future reference. Double-click a response to view details.

![](images/ebenefitHistory.png)
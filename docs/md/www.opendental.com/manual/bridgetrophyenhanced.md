...
* *[Trophy](bridgetrophy.html) Simple*: Not recommended but may be used for new installations of Trophy. It always uses the patient ID (PatNum) as the image folder name.
...
3. Double-click a row in **Additional Properties** to change settings.
   1. Storage Path: Enter the folder path where images are stored.
   2. Enter 1 to enable Numbered Mode
   3. Enter 0 to use the 5th and 6th digits, or 1 to use the last 2 digits, of the Patient Number for folder creation in Numbered Mode

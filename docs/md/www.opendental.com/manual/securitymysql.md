...
When users connect from the client computers, they never see or have access to the users that are set up in this file. They connect using an Open Dental username and password. See [Choose Database](choosedatabase.html) for an example.

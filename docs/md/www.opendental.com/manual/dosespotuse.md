...
We recommend adding medications through DoseSpot to be considered for interactions (i.e., drug-drug or drug-allergy). Medications added to DoseSpot are automatically listed in Open Dental.

To add a medication as Patient Reported in DoseSpot:
...
4. Fill out the following fields:
   ...
   * **Pharmacist's Message**: If the prescription requires a CDT code, enter it in this field.
...
1. From the Admin Console website, click **Clinics** in the upper right corner of the admin console.
2. Click **Edit** under the Details area for the desired clinic.
3. Select the Clinic Favorites tab.
4. Click **Add New Favorite** and add prescription information. Medication name, name of favorite, strength, patient directions, dispense amount, dispense unit, and days supply are required. Pharmacy notes and Substitution Allowed are optional.
5. Click **Submit.**

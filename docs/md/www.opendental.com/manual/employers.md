...
In the [Main Menu](mainmenu.html), click Lists, Employers.

![](images/employers.png)

This list is automatically updated when a new employer is entered from [Edit Patient Information](patientedit.html) or [Insurance Plan](insplan.html).

* **Add**: Create a new employer.
* **Delete**: Highlight an employer from the list and click to remove it.
* **Edit**: Highlight an employer from the list and click to make changes.
